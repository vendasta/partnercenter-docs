...
45. **Round portrait images carry no frame.** AI employee face portraits render as bare circles (`width` + `borderRadius: '50%'` only); the repo's standard image style (border, shadow) applies to screenshots and diagrams, not portraits. Confirmed as the intended pattern on PR 1073 review (2026-08-28).
