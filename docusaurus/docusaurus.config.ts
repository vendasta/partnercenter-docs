    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          // Automations: categorize-with-ai moved from /steps/ to /ai-actions/
          ...
          // Automations: sort-text-with-ai → categorize-text-with-ai → categorize-with-ai (now canonical, under ai-actions/)
