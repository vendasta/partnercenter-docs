...
Each of those is a procedure in its own right, and none of them is a single click. [Hire your first AI Employee](/learn/ai-workforce) walks the AI pieces hands-on, and [Get set up](/learn/getting-started/turn-on-your-own-ai-receptionist) covers the receptionist and the widget end to end. What this step adds is the order, because running them in any other one means redoing work.
