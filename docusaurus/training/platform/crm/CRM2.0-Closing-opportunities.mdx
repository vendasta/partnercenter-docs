...
<CommentBox variant="reflection" prompt="Think about your current pipeline. Is there an opportunity where you could apply the MEDDPICC framework or log an activity you've been meaning to track? What's one step you'll take today?" />
