...
<CommentBox variant="reflection" prompt="Think about a business type you work with or plan to configure. What purpose prompt tone and knowledge sources would you prioritize first, and what test questions would you use to verify the setup?" />
