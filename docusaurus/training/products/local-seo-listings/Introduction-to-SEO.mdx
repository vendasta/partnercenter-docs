...
<CommentBox variant="reflection" prompt="Recall a conversation where a partner or client questioned the value of SEO. How would you now explain the difference between on-page, off-page, and technical SEO to set realistic expectations?" />
