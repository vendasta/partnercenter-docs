...
<LabChecklist
  ...
  steps={[
    ...
    <>Fill in the required fields: company name, contact name, email addresses, phone number, address, country, city, state/province, and postal code.</>,
    <>Save.</>,
...
Go to `Administration` → `My billing`, then select the `Estimated Usage` tab.
