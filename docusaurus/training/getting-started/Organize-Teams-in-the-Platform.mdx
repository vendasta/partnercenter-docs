...
<CommentBox variant="reflection" prompt="How would you organize your team in the platform today? Who would you add as a Partner Center Admin vs. a CRM user — and are there any permission restrictions you'd set right away?" />
