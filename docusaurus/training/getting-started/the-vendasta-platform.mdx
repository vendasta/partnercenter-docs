...
<IconFlipCardGrid>
  ...
  <IconFlipCard
    gradient="green"
    front="Salesperson"
    back="A focused view of Partner Center: Opportunities and My Meetings, for working pipeline and talking to clients."
  />
  <IconFlipCard
    gradient="purple"
    front="Digital Agent"
