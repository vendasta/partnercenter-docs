...
A client whose AI Employee texts United States numbers registers their business with the carriers first (the registration is called A2P). It happens in their Business App, under `Administration` → `Conversation Settings`, and verification runs from one week up to a month, so start it as soon as a client plans to text, with their website and privacy policy live before you submit. Businesses outside the United States have nothing to register today. [This guide covers what the carriers check](/business-app/conversations/sms/us-businesses-sms-registration).
:::
