...
A client whose AI Employee texts United States numbers registers their business with the carriers first (the registration is called A2P). It happens in their Business App, under `Administration` → `Conversation`, and approval takes anywhere from one week up to a month, longer when it does not. Start it as soon as a client plans to text, and have their website, privacy policy, and terms of service live before you submit, because the carriers check all three. Canadian businesses have nothing to register today; requirements in other markets vary as SMS opens up in them. [This guide covers what the carriers check](/business-app/conversations/sms/us-businesses-sms-registration).
:::
