---
title: "Master Sales: The elevator pitch"
sidebar_label: "The elevator pitch"
sidebar_position: 2
...
<LessonFooter to="/learn/sales/run-a-discovery-call" pathName="Master Sales Series" step={2} totalSteps={9} />
