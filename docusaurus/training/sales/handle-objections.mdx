...
<LessonFooter to="/learn/sales/master-sales-skill-check" pathName="Master Sales Series" step={5} totalSteps={5} title="Last step done. Ready to test it?" />
