...
The full vocabulary fits in five lines. The first four are the sections of the `Configure` page you meet in the next path, in the order you meet them; the fifth is the system standing on either side of it.
