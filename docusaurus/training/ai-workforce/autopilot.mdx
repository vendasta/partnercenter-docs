...
*You are here: Partner Center, the same account you have been building on.* The workforce so far only acts when spoken to. An automation is what runs when nobody is in the conversation at all.
