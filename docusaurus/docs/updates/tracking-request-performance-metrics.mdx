...
sidebar_position: 5
description: Learn how to track and analyze request performance metrics for multi-location businesses
---
...
![Reputation Tab for Business Groups](/img/updates/30634671036183.jpg)

**Step 3: Locate the "Requests" Sub-Menu**

Under the **Reputation** tab, select the **Requests** sub-menu to access performance metrics.

![Metrics for Multi-location Request Performance](/img/updates/30634671036695.jpg)

![Business Group Request Metrics](/img/updates/30634642710679.jpg)

## Understanding the Request Performance Metrics

![Filtering Options for Business Group Metrics](/img/updates/30634671042711.jpg)
...
![Location-Specific Metrics for Request Performance](/img/updates/30634671044247.jpg)
...
![Trend Analysis for Request Performance](/img/updates/30634642722711.jpg)

## Using These Metrics

These enhanced metrics enable you to:

- Compare the performance of different locations within a business group
- Identify high and low-performing locations
- Track improvements over time
- Make **data-driven decisions** to improve your review and feedback request strategies
- Demonstrate value to your multi-location business customers

By leveraging these insights, multi-location businesses can ensure better engagement and stronger customer relationships across all their locations.