...
:::info
The Snapshot Report shows the **top 2 review sources** by volume. To see the full list of review sources for a business, use **Reputation AI** in Partner Center.
:::
...
![Listing Score in Snapshot Report](./img/snapshot-report/listings-grade.jpg)
