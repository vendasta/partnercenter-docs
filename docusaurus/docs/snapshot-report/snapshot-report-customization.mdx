...
For a single report: open the report in **Edit Report** mode and uncheck the box beside any section you do not want the client to see. For all accounts: Navigate to **Partner Center > Customize > Partner Defaults > Sales > Edit Default Snapshot Template** and toggle off unwanted sections. For specific markets: Go to **Partner Center > Customize > Markets > Select Market > Sales > Edit Default Snapshot Template** and check boxes to remove sections.
</details>
