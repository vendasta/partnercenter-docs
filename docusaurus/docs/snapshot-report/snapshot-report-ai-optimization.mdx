...
# Snapshot Report section – AI Optimization

## What is AI Optimization?

The AI Optimization section is a new feature in the Snapshot Report that helps you understand whether a business appears in AI-generated search results. As more customers use AI tools like Google AI Mode and ChatGPT to find businesses and get direct answers, businesses need to know if they're being discovered in these new search experiences.
...
#### llms.txt
A brief markdown file that provides AI models with a clean summary of your site and guidance on how to use your data. This helps AI systems understand what your business offers and how to present it to users.
...
- **Using realistic personas**: Tests with 2 different customer personas to reflect how different types of customers might search
...
The AI Optimization section is available in Snapshot Reports created after the release:
...
<!-- ![AI Optimization Section Overview](./img/snapshot-report/ai-optimization-section.png) -->

### AI Readiness Audit

The AI Readiness section shows which foundational elements are present or missing, including robots.txt and llms.txt configuration.

<!-- ![AI Readiness Audit](./img/snapshot-report/ai-readiness-audit.png) -->

### AI Visibility Audit

The AI Visibility section shows detailed results for each persona and AI engine combination, including competitive comparisons and response analysis.

<!-- ![AI Visibility Audit](./img/snapshot-report/ai-visibility-audit.png) -->
