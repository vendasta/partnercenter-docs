...
<details>
<summary>Why does the SEO score seem inaccurate for a client's business?</summary>
...
<details>
<summary>Why do local businesses score poorly in national-level analysis?</summary>
