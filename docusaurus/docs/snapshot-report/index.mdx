...
description: A comprehensive guide to creating, sending, and using Snapshot Reports to assess prospects' digital marketing performance across eight key areas.
...
For a single report: open the report in **Edit Report** mode and uncheck the box beside any section you do not want the client to see. For all accounts: **Partner Center > Customize > Partner Defaults > Sales > Edit Default Snapshot Template** > Toggle off sections. For specific markets: **Partner Center > Customize > Markets > Select Market > Sales** > Edit template and check boxes to remove sections.
</details>
