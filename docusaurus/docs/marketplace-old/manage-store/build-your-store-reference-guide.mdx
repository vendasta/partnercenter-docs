...
- Configure an upgrade path for Standard products.
...
If your product requires additional configuration, add-ons, integrations, or more, then you can continue editing the product in Vendor Center.
