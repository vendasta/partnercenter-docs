...
sidebar_label: Activate for all accounts
sidebar_position: 5
...
2) Next, it's time to create a list of all accounts you would like to activate CalendarHero for. Follow the steps [listed in this guide](/accounts/accounts-lists/create-user-lists-bulk-import-users) to create your list. Follow the steps listed in this guide to add accounts to that list.
