...
id: legacy-proposals
title: Proposals
description: "Create, manage, and track proposals with templates, PDFs, notifications, and Snapshot Reports in Commerce."
sidebar_position: 1
...
Create, manage, and track professional proposals from **Partner Center** → **Commerce** → **Proposals**. Proposal Builder provides customizable templates, professional PDFs, notification tracking, flexible pricing, and Snapshot Report integration to help you close deals.

## What is Proposal Builder?

Proposal Builder is a tool in Commerce for creating professional proposals. You can create, edit, and track proposals with customizable templates, professional PDF generation, notification tracking, flexible pricing displays, and integration with Snapshot Reports.

## Why use it?

Professional proposals help win business and communicate value. Proposal Builder keeps your presentation consistent, shows client engagement, and works with Snapshot Reports so prospects see their needs—and you can follow up at the right time.
...
Turn proposals into polished PDFs to share with clients.
...
From the Proposals dashboard you can view all proposals and their statuses, edit or duplicate proposals, and archive ones you no longer need.
