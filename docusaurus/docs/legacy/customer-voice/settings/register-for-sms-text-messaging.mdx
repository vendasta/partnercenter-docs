...
sidebar_position: 2
description: Learn how to register your business for SMS text messaging in Customer Voice and Reputation AI Premium to ensure your messages aren't blocked by major carriers.
---
...
To reduce spam messages, major mobile carriers like T-Mobile and AT&T block messages delivered from unregistered businesses in the United States.

US-based businesses using Customer Voice or Reputation AI Premium must register their business to send text messages confidentially without getting blocked by the major carriers. This update applies to any account that has Customer Voice or Reputation AI Premium and has purchased an SMS Add-on Package and plans to send review requests via text messages.
...
In an effort to create a more trusted and regulated ecosystem, A2P 10DLC requires businesses to register their business information and campaign information with the carriers. For clients, registration is required for those using Inbox (through Business App), Customer Voice or Reputation AI Premium to send notifications, marketing/promotional messages, and review requests.

### How does a business register?

**In Customer Voice -**

When logging into Customer Voice, you'll find two notification banners. The first can be clicked to get to the form.
...
**Q: The business has already registered via Inbox. Do they need to register again for Reputation AI Premium?**

A: No! Reputation AI Premium, and Inbox use the same phone number. Reputation AI review requests will be logged as events in Inbox messages, and replies will show in Inbox as well.
