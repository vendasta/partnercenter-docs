...
### Reputation
Coach clients to respond to new reviews through Reputation Management to maintain search visibility.
...
Bundle Business App with these recommended add-ons:

- [Conversations Pro](/business-app/conversations/conversations-ai/)
...
Yes. Connecting Facebook, Google Business Profile, or other social accounts inside Business App automatically shares those connections with products such as Social Marketing, Reputation Management, and Local SEO. Even if no products are active, the Marketing Funnel still displays insights sourced from connected accounts.
