...
- **Other** - Custom lead sources are automatically grouped here. When multiple sources are grouped under **Other**, hover over or click the row to see the individual sources included
