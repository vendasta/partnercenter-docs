...
<!-- TODO: Add screenshot of Executive Report customization interface once available -->
<!-- ![Executive Report Customization Interface](./img/executive-report-sections-customization.png) -->
...
- **Market B** might focus on Reputation Management and Social Media
...
- [Customize Business App Settings](/administration/my-account/customize-business-app)
