...
slug: /business-app/executive-report
...
The Executive Report includes data from multiple marketing channels:

- **[SEO](/business-app/executive-report/seo)** - Google Search Console and MarketGoo data
- **[Advertising](/business-app/executive-report/advertising)** - Google Ads and Facebook Ads performance via Advertising Intelligence
- **[Website](/business-app/executive-report/website)** - Website Pro presence and Google Analytics metrics
- **[Reputation](/business-app/executive-report/reputation)** - Review Grade and Google Q&A monitoring
- **[Fulfillment](/business-app/executive-report/fulfillment)** - Tasks, projects, and updates from your team
- **[Finance](/business-app/executive-report/finance-quickbooks)** - QuickBooks Online income, expenses, and notifications
...
![Partner Center Administration Menu](./img/customize-default-report-1.jpg)

2. Go to the **Notifications** tab and click **Notification settings**

![Notifications Tab](./img/customize-default-report-2.jpg)
...
![Executive Report Notification Settings](./img/customize-default-report-3.jpg)
...
You cannot edit or remove sections from the Executive Report, but you can rearrange the sections. Navigate to Partner Center > Administration > Customize Business App > Pages > Executive Report, then click the two horizontal lines next to any section and drag them up or down to reorder them.
</details>
