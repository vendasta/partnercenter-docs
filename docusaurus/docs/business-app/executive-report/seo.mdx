...
- In **Business App > Administration > Integrations > Browse**, you'll find a card to connect to Google Search Console.
...
- Go to **Business App > Administration > Integrations > Browse and click on the Google Search Console card** to edit the search queries.
