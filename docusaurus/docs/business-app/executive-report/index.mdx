...
description: "How the Business App Executive Report works: included sections and products, setup, delivery schedule, recipients, and notification settings."
...
kb_id: KB-00198
answer_snippet: "The Executive Report in Business App is an automatically generated, white-labeled report that rolls up your client's metrics from products across the platform, such as reviews, listings, social, website, SEO, and advertising. It's emailed to clients weekly, monthly, or both."
...
The Executive Report in Business App is an automatically generated, white-labeled report that rolls up your client's metrics from products across the platform, such as reviews, listings, social, website, SEO, and advertising. It's emailed to clients weekly, monthly, or both. Clients can also view it anytime in Business App to see the return on their investment.
...
- **Metrics** from across the marketing stack, including Reviews, Listings, Social, Website, SEO, and Advertising
...
- **Data within minutes** - Useful personalized data appears in the report within 5 minutes after running a Snapshot Report or authenticating Google Business Profile
...
- **[Leads](/business-app/executive-report/leads)** - Lead capture, phone calls, AI receptionist, web chat, and form submission metrics  
- **[Website](/business-app/executive-report/website)** - Website performance and analytics data
- **[Reputation](/business-app/executive-report/reputation)** - Review management and online reputation data
- **Social** - Social media marketing and engagement metrics
- **Listings** - Business listing accuracy and visibility data
- **[SEO](/business-app/executive-report/seo)** - Search engine optimization and organic traffic data
- **[Advertising](/accounts/reports/executive-report-advertising)** - Paid advertising performance across platforms
...
## How do I set up the Executive Report? {#quick-setup-steps}
...
### 1. **Customize your report sections**
   ...
   - See our [Customization Guide](/accounts/reports/customize-executive-report) for detailed steps
...
## How do I view and navigate the Executive Report? {#how-to-view-and-navigate-the-executive-report}
...
## When is the Executive Report sent? {#when-reports-are-sent}
...
## Who receives Executive Report emails? {#executive-report-notifications}
...
2. Go to the `Notifications` tab and click `Notification settings`
...
3. Choose the market (if applicable) and select the `Business App` tab
4. Here you can `Enable` or `Disable` monthly or weekly frequencies for the Executive Report
...
<details>
<summary>What retention benefits does the Executive Report provide?</summary>
...
<details>
<summary>How does the Executive Report work?</summary>
...
<details>
<summary>Can I customize the Executive Report?</summary>
...
These customizations help ensure your client-facing reporting focuses on the areas where you provide value. See our [Executive Report Customization Guide](/accounts/reports/customize-executive-report) for detailed instructions.

</details>

<details>
<summary>How do I turn off the Executive Report?</summary>
...
<details>
<summary>How do I change the Executive Report to weekly frequency?</summary>
