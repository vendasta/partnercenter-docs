...
![Edit notifications screen showing the Business app tab](/img/business-app-executive-report/edit-notifications-business-app.jpg)

**To bulk update:**  
Partner Center > Accounts > Manage Users > Bulk Update > Notifications tab > Business app.

![Bulk update screen showing the Business app section](/img/business-app-executive-report/bulk-update-business-app.jpg)