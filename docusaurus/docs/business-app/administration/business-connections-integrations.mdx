...
sidebar_label: Connections & Integrations
sidebar_position: 5
...
**Steps:**
1. In Business App, go to **Administration** → **Connections** → **Browse**.
...
You cannot remove a Facebook connection from within the Connections settings directly. To remove it:
...
**Steps:**
1. Go to **Administration** → **Connections** → **Browse** and find the **WhatsApp** card.
...
**Steps:**
1. Go to **Administration** → **Connections** → **Browse** and find the **LinkedIn** card.
...
You cannot remove a Facebook connection from the Connections settings directly. Instead, go to the product that uses the Facebook connection (e.g., Reputation Management), find the Facebook page listing, and select **Remove this match** to disconnect it.
</details>
