...
Integrations enable businesses to connect their most important external accounts and services directly to Business App. This creates a centralized hub where Google Business Profile, Google Analytics, Facebook, QuickBooks, and dozens of other business tools can share data and automate workflows. These connections power analytics in the Executive Report, enable automated review requests, and streamline business operations by eliminating the need to manage multiple separate platforms.
...
1. **Find the LinkedIn Ads integration card**
   - Go to **Administration** → **Connections** → **Browse**
...
4. **Verify and configure from Manage**
   - Open the **Manage** tab in Connections
