...
1. Go to the product powered by the Facebook connection (e.g., **Reputation Management**).
...
You cannot remove a Facebook connection from Integrations directly. Instead, go to the product that uses the Facebook connection (e.g., Reputation Management), find the Facebook page listing, and select **Remove this match** to disconnect it.
</details>
