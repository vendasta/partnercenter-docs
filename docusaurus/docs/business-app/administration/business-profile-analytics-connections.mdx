...
sidebar_position: 6
description: "Manage the Business App business profile, check Google Business Profile verification, and connect Google Business Profile and GA4 in Integrations."
...
kb_id: KB-00170
answer_snippet: "Business App lets you manage business profile information at My Business → Business Profile, check Google Business Profile verification status, and connect Google Business Profile and Google Analytics 4 (GA4) at Administration → Integrations."
...
Business App lets you manage business profile information at `My Business` → `Business Profile`, check Google Business Profile verification status, and connect Google Business Profile and Google Analytics 4 (GA4) at `Administration` → `Integrations`.
...
- **Analytics** - Google Analytics data powers Executive Reports and performance insights
...
- Update business hours, location, contact information, and booking link URL
...
- Connect Google Analytics 4 (GA4) properties to WordPress Hosting
...
## How do I set up Business Profile and Analytics connections? {#how-to-set-up-business-profile--analytics-connections}

### How do I manage my business profile? {#how-to-manage-your-business-profile}
...
2. **Update Business Information**
   ...
   - Add or update the booking link URL used for appointment scheduling
...
3. **Sync Across Products**
   - Business Profile automatically syncs with:
     ...
     - Reputation AI profile information
...
### How do I check Google Business Profile verification status? {#how-to-verify-google-business-profile-status}
...
### How do I connect Google Analytics? {#how-to-connect-google-analytics}
...
1. **Access Google Analytics Connection**
   - Navigate to `Business App` → `Administration` → `Integrations`
...
### How do I use GA4 tracking on a WordPress site with WP Cloud Client? {#use-ga4-tracking-on-a-wordpress-site-with-wp-cloud-client}

If a WordPress site uses the **WP Cloud Client** plugin, GA4 can be sent to the site from two sources:

- **Connected GA4 property** from `Business App` → `Administration` → `Integrations`
...
### How do I connect Google Business Profile to Business App? {#how-to-connect-google-business-profile-to-business-app}

1. **Access Integrations**
   - Navigate to `Business App` → `Administration` → `Integrations`
   - Find Google Business Profile in available integrations
...
- **Executive Reporting**: Performance data in Executive Reports

### Cross-Platform Integration
- **Local SEO**: Business profile data enhances local search optimization
- **Reputation AI**: Connected profiles enable review monitoring and response
- **WordPress Hosting**: Analytics data provides website performance insights
- **Website integrations**: Business Profile fields, including booking link URL, can be used by website components that read Business Profile data
- **Executive Report**: All connected data feeds into business reports
...
- **Missing Booking Link**: Ensure the booking link field contains a valid URL
...
Yes, the Business Profile syncs across Local SEO, Reputation AI, and Partner Center. Changes made in one location automatically update everywhere, ensuring consistency across all platforms.
</details>
...
<details>
<summary>How do I add a booking link to my business profile?</summary>

Access `My Business` → `Business Profile` in Business App, add a full booking URL (including `https://`), and save your changes. Integrations that use Business Profile data can use this value where booking links are supported.
</details>
