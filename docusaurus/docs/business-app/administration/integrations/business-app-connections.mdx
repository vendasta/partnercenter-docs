...
slug: /business-app/administration/business-app-connections
---
...
Learn more about connecting accounts to Business App:

- [Integrations Overview](/business-app/administration/integrations-overview) - Complete guide to all integration types
