...
Use the **Verified** tag inside Business App or the Google Business Profile dashboard to confirm status. See the [FAQ section below](#how-do-i-confirm-if-a-google-business-profile-listing-has-been-verified) for detailed verification steps.
