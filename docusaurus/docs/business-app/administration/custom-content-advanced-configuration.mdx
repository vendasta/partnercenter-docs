---
title: "How do I set up custom guides and advanced configuration in Business App?"
sidebar_label: Custom Content & Configuration
sidebar_position: 9
description: "Turn on Business App Guides, show white-label or WordPress blog content filtered by tag ID, and set up Clio opt-in and opt-out sync triggers."
...
content_type: how-to
kb_id: KB-00193
answer_snippet: "Custom content and advanced configuration for Business App let you turn on the Guides section, show Vendasta's white-label content or your own WordPress blog posts as guides, and set up Clio custom-field triggers that control which client data syncs."
...
Custom content and advanced configuration for Business App let you turn on the Guides section, show Vendasta's white-label content or your own WordPress blog posts as guides, and set up Clio custom-field triggers that control which client data syncs.
...
## How do I set up custom content and advanced configuration? {#how-to-set-up-custom-content--advanced-configuration}

### How do I configure guides in Business App? {#how-to-configure-guides-in-business-app}
...
### How do I set up WordPress blog integration? {#how-to-set-up-wordpress-blog-integration}
...
### How do I find WordPress tag IDs? {#how-to-find-wordpress-tag-ids}
...
### How do I set up Clio integration triggers? {#how-to-set-up-clio-integration-triggers}
...
## How do I troubleshoot custom content issues? {#troubleshooting-common-issues}
...
The integration only supports filtering by WordPress tag IDs. You cannot filter by categories, so ensure your content strategy uses tags for organization.
</details>
