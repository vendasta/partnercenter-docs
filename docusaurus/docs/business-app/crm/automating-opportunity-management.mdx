...
This article covers opportunities in Business App. To learn more about opportunities in Partner Center, click [here](/crm/opportunities).
...
Using AI to qualify leads, you can analyze a webchat summary to identify the requested service, creating an opportunity if the lead meets the criteria. This workflow requires the **Conversations AI Pro** product.
