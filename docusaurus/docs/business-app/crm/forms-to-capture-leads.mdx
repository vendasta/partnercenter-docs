...
You can add a **File upload** field to your form to let visitors attach documents or images when they submit. Files uploaded via forms are attached to the CRM record that the form creates and receive an AI-generated summary for easier review.
...
3. Optionally set accepted file types (for example: PDF, PNG, JPEG, DOCX) and a maximum file size.
4. Save the form and test a submission to confirm the file attaches to the created Contact or Company record.
...
* Forms are a key way to capture leads. Form builder makes it very easy to setup, and the CRM + Conversations makes it easy to manage to leads from form fills.
...
Yes. Add a **File upload** field to let visitors attach a document or image when submitting. Files uploaded through forms attach to the Contact or Company the form creates and an AI-generated summary is created for easier review. Test your form after adding this field to confirm the file attaches correctly.
