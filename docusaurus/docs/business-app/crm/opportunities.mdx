...
![Opportunities List View](./img/crm/opportunities-list-view.png)

## Opportunity Profiles

Each opportunity has its own profile page that contains all relevant information.

![Opportunity Profile Page](./img/crm/opportunity-profile-page.png)
...
![Create Opportunity Button](./img/crm/create-opportunity-button.png)

2. Fill out the opportunity details in the form

![Create Opportunity Form](./img/crm/create-opportunity-form.png)
...
![Edit Opportunity Profile](./img/crm/edit-opportunity-profile.png)

### From the Table View

Click the three dots menu next to an opportunity and select **Edit**.

![Edit Opportunity Table View](./img/crm/edit-opportunity-table-view.png)

## Opportunity Value Analytics

The CRM provides analytics on the total value of your opportunities, broken down by stage.

![Opportunity Value Pie Chart](./img/crm/opportunity-value-pie-chart.png)
