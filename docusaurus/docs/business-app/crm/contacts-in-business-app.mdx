...
<details>
<summary>Can I export contacts or companies from Business App?</summary>

Yes, contacts and companies can be exported using the following steps:
1. Set the filters to populate the desired information.
2. Select the all the contacts or companies > click select all.

![crm-export](./img/crm/crm-export.png)

3. Actions > export.

A notification will be sent to you once your CSV is ready to download.
</details>