...
- **[Getting Started with Opportunities in Business App](./opportunities.mdx)** – Creating and editing opportunities, pipeline and list views, opportunity profiles
- **[Creating and Customizing Your Sales Pipeline](./sales-pipeline.mdx)** – Setting up pipelines, adding and removing stages, multiple pipelines
- **[Forms to capture leads in Business App](./forms-to-capture-leads.mdx)** – Creating forms, adding fields, embedding on your site, and connecting to CRM and Conversations
...
### 1. **Set up a sales pipeline**
   ...
   - See [Creating and Customizing Your Sales Pipeline](./sales-pipeline.mdx) for details
...
Go to **Business App** > **CRM** > **Opportunities** and click **Set up a pipeline**. You can add stages, set close probability for each stage, and create multiple pipelines. The **Closed Won** and **Closed Lost** stages are required and cannot be removed. See [Creating and Customizing Your Sales Pipeline](./sales-pipeline.mdx) for full details.
</details>
