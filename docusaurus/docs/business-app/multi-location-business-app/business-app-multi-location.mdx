...
![Create Groups](/img/business-app/multi-location/create-group-1.jpg)
...
{/* ![Multi-Location Dashboard](/img/business-app/multi-location/dashboard.jpg) */}
...
{/* ![Manage Multi-Location](/img/business-app/multi-location/location-management.jpg) */}
...
![Create Group from Homepage](/img/business-app/multi-location/create-group-2.jpg)
...
![Add Accounts to Group](/img/business-app/multi-location/add-accounts.jpg)
...
![Create from List](/img/business-app/multi-location/create-from-list.jpg)
...
![Import List](/img/business-app/multi-location/import-list.jpg)
...
![Edit Groups](/img/business-app/multi-location/edit-groups.jpg)
