...
Campaigns Pro is the ultimate marketing automation software designed specifically for local businesses. With Campaigns Pro, creating powerful email campaigns has never been easier. The base Campaign Pro plan includes email campaigns (e.g., 10,000 emails monthly) and does not include SMS sending credits. To send SMS campaigns using Campaign Pro, customers must purchase an SMS add-on product. Fully integrated with Vendasta's Business App, Campaign Pro allows your clients to effortlessly build customized campaigns using our user-friendly builder and ready-made templates. Engage new customers, boost sales, and build anticipation with Campaigns Pro!
...
No, campaign activity can only be viewed from Business App. To view, select a campaign and the number under 'Recipients' to get to the campaign activity table.
</details>

<details>
<summary>How many emails can a business send per month?</summary>

You can send up to 10,000 emails each month by default. You can purchase an additional email-sending limit in increments of 1,000 or 10,000 as an add-on.
</details>

<details>
<summary>Do I need an SMS add-on to use SMS in Campaigns Pro?</summary>

Yes. To send SMS messages in Campaigns Pro, an **SMS add-on is required**.  
Please note that SMS add-ons are **only available in the United States and Canada**.
</details>