...
No, campaign activity can only be viewed from Business App. To view, select a campaign and the number under 'Recipients' to get to the campaign actvity table.
</details>
