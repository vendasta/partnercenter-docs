...
**Q: I don't see the registration option in Conversations?**

A: Registration is only available for US-based businesses, with Conversations AI Pro product active. Ensure the account has an address located in the United States.

**Q: There was a mistake on the registration form I submitted - can I cancel it?**

A: No, the form cannot be edited or canceled once submitted.  If information was missing or incorrect, the registration will eventually move to a 'failed' status. Once registration fails, the form can be resubmitted.