...
**Q: What file types are supported for uploads in the AI Knowledge Base?**  

A: The AI Knowledge Base supports a wide range of file formats (up to 100MB each). You can upload:  
- PDF  
- DOCX  
- HTML  
- Images: JPG, PNG  
