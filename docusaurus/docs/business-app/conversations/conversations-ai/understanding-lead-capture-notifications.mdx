...
kb_id: KB-00060
answer_snippet: "In Conversations, your AI Receptionist captures a web chat visitor's name, email, or phone number as a lead when its Capture leads capability is enabled. You get a New Lead notification when a new CRM contact is created, or a Conversation Update when the visitor is an existing contact."
...
In Conversations, your AI Receptionist captures a web chat visitor's name, email, or phone number as a lead when its `Capture leads` capability is enabled. You get a New Lead notification when a new CRM contact is created, or a Conversation Update when the visitor is an existing contact.

Lead capture works with your AI Receptionist or a custom AI on the web chat widget.
...
- Link to view the full conversation in Conversations
...
An anonymous conversation occurs when a visitor chats without providing any contact information. These conversations appear in the "Anonymous" section of Conversations until the visitor shares identifying details.
...
| Same person, different channel | Contact who previously chatted texts you via SMS |
...
3. **The new conversation stays in Anonymous** - The duplicate conversation remains in the Anonymous section of Conversations
...
If someone other than the intended Salesperson is receiving Conversations notifications, check whether they participated in a conversation (and were auto-followed) or were assigned as Salesperson to the account.
...
- Check the Anonymous section in Conversations to find these conversations
...
**Q: Someone other than the Salesperson is getting Conversations notifications. Why?**
...
**Q: Can I be notified every time a returning lead messages again?**
- Follow-up messages from existing contacts don't trigger a notification by default
- To get alerted on follow-ups, create an Automation with the trigger `A contact communication summary is created` and the action `Send notification`
- This fires after each conversation summary is generated, for both new leads and returning contacts
