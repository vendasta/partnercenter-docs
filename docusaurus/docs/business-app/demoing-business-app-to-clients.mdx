...
4. Walk through creating a post:
   ...
   - AI image generation is available in Social Media Manager and Blogger workflows on web and mobile, with up to 50 AI-generated images per day
...
<details>
<summary>How many AI-generated images can be created in Social Marketing?</summary>

Social Media Manager and Blogger workflows support AI image generation on web and mobile with up to 50 AI-generated images per day. There is no per-minute cap, and generation throughput follows provider API capacity.
</details>
