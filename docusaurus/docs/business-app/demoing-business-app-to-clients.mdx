...
- There is no per-minute AI image generation cap
- Generation throughput and daily capacity are aligned with available provider API capacity
...
Social Media Manager and Blogger workflows support AI image generation on web and mobile. There is no per-minute cap, and generation throughput plus daily capacity follow provider API capacity.
</details>
