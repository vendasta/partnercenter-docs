...
![Automation trigger configuration](/img/business-app/business-app-automations/follow-up-automation-trigger.png)

**Step 2:** Based on your specific need, a simple option is to choose the **Send a plain text email via Inbox** step.

![Send email configuration](/img/business-app/business-app-automations/follow-up-send-email.png)

**OR** - You can opt to create a more advanced workflow such as the following:
![Advanced automation workflow](/img/business-app/business-app-automations/follow-up-advanced-workflow.png)
...
![Automation run example](/img/business-app/business-app-automations/follow-up-automation-run.png)