...
![Sending your first message in Business App Inbox](./img/inbox/send-first-message.png)
...
![Display Inbox Tab setting in Partner Center](./img/inbox/display-inbox-tab.png)