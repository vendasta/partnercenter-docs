...
{/* TODO: screenshot — rendered onboarding email showing the checklist of work done. Anonymize business name/URL. */}
...
- A single call to action — **See what's ready for you** — that takes the SMB to their Business App Home page. The link works whether the user still needs to set a password or can log in directly, and it carries tracking parameters so you can measure engagement.
...
{/* TODO: screenshot — onboarding email preview modal in the create-user flow. */}
...
- **Recommended for \[business name\]** — toggles the recommended product upgrade cards.

Both are **on by default**. Turning a checkbox off hides that section for all of your SMBs. Remember to click **Save**.

{/* TODO: screenshot — Customize Business App → Home showing the two Ignite toggles. */}
