...
Turning a product's upgrade option off in **Marketplace → Manage Products** now removes that product's card from Home entirely, rather than falling back to a **Contact us** button. This keeps **Contact us** meaningful: it appears only when you've deliberately chosen to route that product's upgrades to your sales team.
