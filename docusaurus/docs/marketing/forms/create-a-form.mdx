...
While Forms automatically capture common UTM parameters like `utm_source`, `utm_medium`, `utm_campaign`, `utm_content`, and `utm_term`, it can still be helpful to have the ability to capture other query parameters that are specific to your business.
...
No, whenever someone consents to receive more emails, the CRM will automatically update to show if they came from a specific campaign. This lets us us know which campaigns are specificlly driving more sign-ups to our email list.
