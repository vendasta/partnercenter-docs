...
Form fields can be dynamically filled with the information from the URL using query parameters. Commbined with hidden fields, this can be used to capture information about the source of the form submission. 
...
Forms automatically captures common UTM parameters like `utm_source`, `utm_medium`, `utm_campaign`, `utm_content`, and `utm_term`! If you do not need to capture these  
:::
...
Now, whenever someone consents to receive more emails, the CRM will automatically update to show if they came from a specific campaign. This lets us us know which campaigns are specificlly driving more sign-ups to our email list.

:::tip Tracking form submissions in Google Analytics
...
You will see an "error" message when you select the template. This automation template requires you to choose an email campaign that will be sent to the contact when the form is submitted. Choose an exisiting campaign from the dropdown and then click **Save automation**.
...
If you do not have an appropriate campaign created, you can save the automation and come back later. For more information on creating campaigns, see [Create email campaigns](../campaigns/create-email-campaigns.mdx) to get started.
:::
...
For more information on building automations with the automation builder, see [Create a new automation](../automations/my-automations/create-new-automation.mdx).
:::
