...
3. Upload a reference image (for example, your website) and add a prompt like “Match form design to my website”
4. Add optional instructions (for example, “Put first and last name on the same row”)
5. Review the generated CSS and paste/tweak it under **Custom CSS**
...
:::info Where the generated CSS applies
