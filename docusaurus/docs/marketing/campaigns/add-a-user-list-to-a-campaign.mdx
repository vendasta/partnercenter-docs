...
Once you've [created a user list](/accounts/accounts-lists/create-user-lists-bulk-import-users), you can send an email campaign to the users in that list by adding the list to a campaign.
