...
description: "Create and send drip-style email campaigns from Partner Center, compare Campaigns with Automations, and review sending limits and bounce codes."
sidebar_position: 1
brand: vendasta
product: campaigns
audience: partners
...
kb_id: KB-00104
answer_snippet: "Campaigns, at Marketing → Campaigns in Partner Center, send drip-style sequences of scheduled emails to your contacts, companies, accounts, and lists at fixed intervals. You can personalize emails with dynamic content and track opens and clicks."
doc_owner: campaigns
...
Campaigns, at `Marketing` → `Campaigns` in Partner Center, send drip-style sequences of scheduled emails to your contacts, companies, accounts, and lists at fixed intervals. You can personalize emails with dynamic content and track opens and clicks.
...
- More targeting and timing options
...
- **Email Builder** - Create emails with a drag-and-drop interface
...
- **Use Recommended Templates** - Start with recommended templates and customize as needed
- **Build Custom Campaigns** - Create campaigns from scratch using the Email Builder

### 3. Design your emails

Use the Email Builder to create your emails:
...
Set up automation flows that combine business data with targeted campaigns:
...
These campaign types are organized using **tags** in the main Campaigns list rather than as separate sections in the Campaigns view. All campaigns of these types remain available through the tag filter.
