...
The order of events in a campaign cannot be altered once the campaign is published. To make changes to your campaign, un-publish it first and then make your changes. 
