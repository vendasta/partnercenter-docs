...
Your customers can access **Business App** from a URL that's unique to your agency. You can find your URL below the title on the **[Accounts > Manage Users](https://partners.vendasta.com/bc-admin)** tab in **Partner Center**. The **Growth** and **Scale** plans include the ability to [customize this domain](/getting-started/welcome-to-vendasta/customize-domain).

To give your customers access to **Business App**, you'll need to [create user credentials](/getting-started/welcome-to-vendasta/create-business-center-users) for them. Alternatively, prospects can access **Business App** for free from a Snapshot Report.
