---
title: "How do I fix common Partner Center issues?"
sidebar_label: Partner Troubleshooting Guide
description: "Fix common Partner Center and Business App issues, like login problems, slowness, and failed activations, before contacting Vendasta Support."
sidebar_position: 5
brand: vendasta
...
kb_id: KB-00012
answer_snippet: "If something isn't working in Partner Center or Business App, check status.vendasta.com for outages, clear your cache and cookies, disable browser extensions, and try another browser. If the issue continues, email support@vendasta.com with the details listed below."
...
# How do I fix common Partner Center issues?

If something isn't working in Partner Center or Business App, check status.vendasta.com for outages, clear your cache and cookies, disable browser extensions, and try another browser. If the issue continues, email support@vendasta.com with the details listed below. Each section below explains a common issue and how to fix it, so you can resolve it before escalating to the Vendasta Support team.
...
3. Then, you should be able to proceed with getting a HAR file like normal from the browser:
   - Right click → `Inspect element` → `Network`, check **"Preserve log"**, refresh the page, right click on any lines that appear, and select **"Save HAR"**
...
<details>
<summary>What should I include in a support ticket?</summary>

Include your Partner ID, the Account Group ID if applicable, the affected user, steps to reproduce the issue, and screenshots or a video of any error messages. See [Submitting a Support Ticket](#best-practice-submitting-a-support-ticket).

</details>

<details>
<summary>How do I check whether Vendasta is having an outage?</summary>

Visit [status.vendasta.com](https://status.vendasta.com) before troubleshooting your browser. If there's no active incident, work through the login and cache fixes on this page.

</details>

<details>
<summary>Which browser works best with Partner Center?</summary>

Chrome is recommended. If an issue only happens in one browser, the problem is specific to that browser, so clearing its cache or disabling its extensions usually helps.
