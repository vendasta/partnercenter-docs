...
<img src={require('./img/company-name.png').default} alt="Company Name field in Partner Branding settings" style={{width: '50%'}} />
...
<img src={require('./img/theme-settings.png').default} alt="Theme and Business App Theme settings in Partner Branding" style={{width: '50%'}} />
...
<img src={require('./img/logo-upload.png').default} alt="Logo upload section in Partner Branding settings" style={{width: '75%'}} />
...
<img src={require('./img/company-avatar.png').default} alt="Company avatar and shortcut icon upload section in Partner Branding" style={{width: '75%'}} />
...
<img src={require('./img/favicon-upload.png').default} alt="Favicon upload section in Partner Branding" style={{width: '75%'}} />
...
<img src={require('./img/primary-color.png').default} alt="Primary color picker in Partner Branding settings" style={{width: '75%'}} />
