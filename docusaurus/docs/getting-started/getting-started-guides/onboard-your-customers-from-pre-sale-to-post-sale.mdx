...
2. You are using **Subscriptions** to collect recurrent payments.
   - Learn how to set up and use Subscriptions in Partner Center under Marketplace settings

3. You have selected that you want to **Start Selling** on the products you plan to order.
   - You can learn more about selling products and setting up your store in the Marketplace documentation
...
[Learn more.](../../commerce/orders/creating-and-managing-orders.mdx)
...
[Learn more.](../../accounts/manage-users/add-a-user-to-an-account.mdx)
...
The unbranded video in the section above includes a brief guide on connections for your customers, but you can learn more with this partner-facing video and [the integrations overview](/business-app/administration/integrations).
...
When selling Vendasta's Marketing Services, you can find [unbranded expectation brochures](https://examples.yourdigitalagents.com/expectation-brochures/) that can help you and your customers understand timelines for delivery and more. To learn more about Marketing Services, check out [Getting Started: Using Vendasta Services](/getting-started/getting-started-guides/getting-started-with-vendasta-services) and the [Vendasta Services Resource Overview](/vendasta-services/working-with-our-team/vendasta-services-resource-overview).
...
The **Executive Report** is generated on a weekly and monthly basis. It populates with information based on the connections in Business App and the products that are active. By comparing reports, you and your customer can see how their online presence is improving and what areas to focus on next.
