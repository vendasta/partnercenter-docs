...
[**Learn more.**](/administration/my-account/my-team)
...
If you need help with setting up your DNS records, we have additional information on this process for [GoDaddy](/marketing/email-settings/email-authentication/adding-spf-dkim-dmarc-records-godaddy) and [Namecheap](/marketing/email-settings/email-authentication/adding-spf-dkim-dmarc-records-cpanel-namecheap). If you use a different domain registrar and you are still needing help, you can reach out to our support team.
