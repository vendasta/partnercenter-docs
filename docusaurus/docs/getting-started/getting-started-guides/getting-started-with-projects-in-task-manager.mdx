...
**Projects:** The focus for this guide, projects are a collection of tasks. Typically, they represent the unit of work that your team is completing for a customer (e.g., a Website Build, or a Customer Onboard). The Projects tab shows all of the open and completed projects for your entire team.
...
**Projects page:** This is the main way to view your projects. Here you can create views (e.g., "Overdue by assigned to", "Upcoming due projects for account X", etc.) to easily group and monitor the status and due dates of your projects. 
