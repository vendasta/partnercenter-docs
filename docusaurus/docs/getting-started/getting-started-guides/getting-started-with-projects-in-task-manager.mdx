...
2. **Product**: link a Vendasta Marketplace product (e.g. Reputation AI, WordPress Hosting) to the task. This creates a shortcut inside the task so your team can access the product directly in your customer's Business App.
