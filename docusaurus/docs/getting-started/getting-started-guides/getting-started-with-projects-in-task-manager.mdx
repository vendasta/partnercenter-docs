...
**The Loop:** An activity feed of information inside of Task Manager.
...
2. **Product**: You can select one of Vendasta's core marketplace products (eg. Reputation AI, Website Pro, etc). This will create a link to the product inside of the task that will allow your team to access that product inside of your customer's Business App.
