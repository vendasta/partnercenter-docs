...
<details>
<summary>How do I change a team member's email address or role?</summary>

Go to `Partner Center` → `Administration` → `My team`, click the menu icon (⋮) next to the team member's name, and click **Edit member**. Update their name, email address, role, or permissions, then click **Save**.
