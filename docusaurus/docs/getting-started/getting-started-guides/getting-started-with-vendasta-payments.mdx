...
1. Click **Set up Vendasta Payments**.
...
Navigate to **Partner Center** > **Commerce** > **Payouts**, or go to **Administration** > **Vendasta Payments**.
...
Navigate to **Partner Center** > **Administration** > **Vendasta Payments** and select **Connect Stripe Account**.
