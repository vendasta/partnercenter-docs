...
:::note
**Note:** Some of these steps may include features that are only available on specific subscription tiers.
:::

## **Checklist**

1. [Start selling](#start-selling)
   - [Ready-made packages](#ready-made-packages)
   - [Marketplace products](#marketplace-products)
2. [Prospecting](#prospecting)
   - [Find and add accounts](#find-and-add-accounts)
   - [Create Snapshot Reports](#create-snapshot-reports)
   - [Send Snapshots with AI Analysis](#send-snapshot-reports-with-ai-analysis)
3. [Activate your customers](#activate-your-customers)
   - [Invite users](#invite-users)
   - [Order products and get paid](#order-products-and-get-paid)
   - [Business App connections](#business-app-connections)

## **Start selling**

With Vendasta, you're set up to start selling right away with a collection of ready-made packages and products ready to go. If you want to take full control and customize your store, check out the [**Marketplace Overview**](/marketplace/marketplace-overview.mdx). To dive in quickly, take a look at some of the basics.
...
These recommended packages are pre-built, industry-specific bundles designed to act as growth engines for SMBs. Each package highlights Conversations AI alongside other core digital marketing solutions. Leverage them to sharpen your industry pitch and drive growth in your business with your clients.
...
Accounts can be added in groups and individually. This workflow showcases how to add many accounts at once into a list. To learn more about adding individual accounts or importing them via a csv file, [**go here**](/accounts/manage-accounts/create-accounts.mdx).
...
:::tip
**Tip:** While waiting for information to populate, it's a great time to make some quick edits to the Snapshot Report. If you've added a number of prospects that are part of the same business category, you can flag them as competitors. Check out our [**Snapshot Guide**](/snapshot-report/) for more.
:::
...
:::note
**Prerequisite:** Before sending out any emails through the platform, make sure you have configured your email settings to assure maximum deliverability. These steps are [**showcased in detail here**](/getting-started/getting-started-guides/set-up-and-white-label#configure-your-email-settings).
:::
...
:::note
**Prerequisite:** You can automatically request payment while ordering a product through Vendasta. To do so, you will first need to [**set up Vendasta payments**](/commerce/payments/setting-up-vendasta-payments).
:::
...
The Vendasta platform allows you additional flexibility for full order management of your sales team.

If you are ordering fulfilled services, like those from our Vendasta Services team, after the order is complete, you will be presented with a fulfillment form, an easy way to capture information with the help of your customer.
[Back to top.](#checklist)
