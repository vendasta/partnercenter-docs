...
:::tip
**Tip:** While waiting for information to populate, it's a great time to make some quick edits to the Snapshot Report. If you've added a number of prospects that are part of the same business category, you can flag them as competitors. Check out our [**Snapshot Guide**](/snapshot-report/snapshot-report-overview) for more.
:::
