...
It is a good practice to capture a HAR file to identify potential issues before clearing Cache & Cookies. For browser troubleshooting guidance, see our [premium reports access troubleshooting](../../reports/premium-reports/faq-why-cant-i-access-my-premium-report.mdx) for cookie-related solutions.
:::
...
5. Change the contact information to **Partner's Contact Information** from **None**
...
2. Once the refund has been issued, your partner can see it in **Partner Center** by going to **Administration > Financial Documents > Credit Notes**

### Resource

[Credit Notes and Billing Features](../../administration/my-account/my-billing/special-features-and-credits.mdx) - Partner billing and credit information
