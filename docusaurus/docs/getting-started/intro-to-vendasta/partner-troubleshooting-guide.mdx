...
## How to Generate a Network (HAR) File
...
7. With the network panel open, **refresh the page** and attempt the action again (if there is an action)
8. Right-click on any of the lines/info
9. Select **"Save all as HAR File with content"**
10. Save it to your documents or area on your PC you wish to access it from
11. You can then email the file to the Support On Demand team upon request for us to diagnose
...
For additional browser troubleshooting, see [premium reports access issues](../../reports/premium-reports/faq-why-cant-i-access-my-premium-report.mdx) which covers cookie and browser-related problems.
...
It is a good practice to capture a HAR file to identify potential issues before clearing Cache & Cookies. See the HAR file section above for detailed instructions.
:::
...
For browser cache troubleshooting, see [premium reports access issues](../../reports/premium-reports/faq-why-cant-i-access-my-premium-report.mdx) which covers cookie and browser-related problems.
...
## Product Activation Failed but I was Charged
...
[Package Troubleshooting Guide](../../marketplace/packages/package-troubleshooting-guide.mdx) and [Store Product Visibility](../../marketplace/manage-store/store-sharing-customer-experience.mdx)
...
[Reputation Management Standard vs Pro Editions](../../vendasta-products/general/getting-started/standard-pro-product-editions.mdx)
...
For support contact guidance, see [Partner Center Support Information](../../partner-center/overview.mdx#support-on-demand)
...
[Submitting a Support Ticket](../../partner-center/overview.mdx#submitting-a-support-ticket)
...
<details>
<summary>What browsers support HAR file generation?</summary>

Most modern browsers support HAR file generation including Chrome, Firefox, Safari, and Microsoft Edge. The steps may vary slightly between browsers, but the Network tab in Developer Tools is the standard location for this feature.
</details>
