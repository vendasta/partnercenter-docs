...
Below are the steps you would follow when selecting a custom package to be the upgrade option. These steps use Reputation AI Standard as an example.

Before configuring the upgrade workflow, you must have a package created and published to your Store. Follow [these steps](/marketplace/packages/packages-overview-creation) to add products to a package and publish them to your Store.

Best practices to follow in creating your custom package:

- Include the Pro edition of the product in the package (i.e. Reputation AI Pro)
...
1. With a package created and added to your Store, go to **Marketplace** > **Products** > **Reputation AI**
...
Below are the steps your SMB client would follow when choosing to upgrade their Standard product. These steps use Reputation AI Standard as an example.

1. From **Business App** > **Reputation AI Standard**
