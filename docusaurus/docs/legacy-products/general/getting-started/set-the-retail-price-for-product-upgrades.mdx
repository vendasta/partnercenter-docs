...
description: Learn how to set retail prices for product upgrades such as Reputation AI, Customer Voice, Website, and Social Marketing in Business App.
sidebar_label: Set the retail price for product upgrades
---

When a customer clicks on a Pro feature in [Business App](/business-app), they are prompted to upgrade from the Standard edition of the product to the Pro edition. Business App displays the Pro edition Manufacturer's Suggested Retail Price (MSRP) by default. This article provides instructions on how to set the retail price to a new value.

- [Set retail prices](#set-retail-prices)
  - [A. Reputation AI, Customer Voice, Website, and Social Marketing](#a-reputation-management-customer-voice-website-and-social-marketing)
  - [B. Advertising Intelligence](#b-advertising-intelligence)
  - [C. Local SEO](#c-local-seo)
- [Reset retail prices](#reset-retail-prices)

![Product upgrade intro](./img/products/legacy-products/product-upgrade-intro.jpg)

## Set retail prices

### A. Reputation AI, Customer Voice, Website, and Social Marketing

To set the retail price for a Reputation AI, Customer Voice, or Social Marketing product upgrade:
