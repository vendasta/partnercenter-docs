...
5. For setting the upgrade path to **Upgrade to a custom package**, [follow these instructions](/legacy-products/general/getting-started/configure-standard-products-upgrade-paths-to-custom-packages).
...
![Custom modal content configuration screen](./img/products/legacy-products/upgrade-path-custom-modal.png)
