...
![CSV Upload AI Personalization](./img/multi-location-AI-Personlization.png)
...
![CSV Personlization in progress](./img/multi-location-AI-Personlization-in-progress.png)
* Once ready, a blue tag `Personalized for location` appears.
![CSV Personlized](./img/multi-location-AI-Personlized.png)
