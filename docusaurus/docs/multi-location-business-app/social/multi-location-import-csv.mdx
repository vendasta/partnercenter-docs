...
![CSV Upload AI Personalization](./img/multi-location-AI-Personalization.png)
...
![CSV Personalization in progress](./img/multi-location-AI-Personalization-in-progress.png)
* Once ready, a blue tag `Personalized for location` appears.
![CSV Personalized](./img/multi-location-AI-Personalized.png)
