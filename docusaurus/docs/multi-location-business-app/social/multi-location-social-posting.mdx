...
- Post to multiple Facebook, Instagram, LinkedIn, or Google Business Profile pages in one go
...
Multi-location posting supports **Facebook**, **Instagram**, **LinkedIn**, and **Google Business Profile**. X and other platforms must be posted to individually from each location's own Social Marketing app.

**LinkedIn:** When composing a post, use the **Only LinkedIn business pages** toggle to control which LinkedIn accounts receive the post. When enabled, the post is sent to LinkedIn business pages only. When disabled, the post is sent to both personal profiles and business pages.
