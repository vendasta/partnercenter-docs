...
title: "How do I post to multiple locations with Multi-location Business App?"
sidebar_position: 1
description: "Create and schedule social posts for many locations at once in Multi-location Business App, with per-location dynamic content and performance stats."
brand: vendasta
...
content_type: how-to
kb_id: KB-00162
answer_snippet: "Multi-location Business App social posting lets you create and schedule one post that publishes to the connected Facebook, Instagram, and Google Business Profile pages of many locations at once. Each location needs Social AI Standard or Pro."
...
Multi-location Business App social posting lets you create and schedule one post that publishes to the connected Facebook, Instagram, and Google Business Profile pages of many locations at once. Each location needs Social AI Standard or Pro.

With Multi-location Business App social posting, you can:
...
## How do I create a multi-location post? {#creating-a-post}
...
## How do I customize a post for each location? {#dynamic-content}

Once you've refined the locations, you can proceed with creating your post. Using dynamic content, you can customize your post for each location. Click the dynamic content icon ![Dynamic content icon](../img/multi-location/15668511743127.png) to add any of the following information:
...
## How can a location customize a multi-location post? {#easy-customization}
...
Go to `Business App` → `Social AI` → `My Posts` → `Scheduled Posts` or click **View More** on the Scheduled Posts section on the Overview page. You will see the scheduled multi-location post and will be able to edit it.
...
## How do I manage multi-location posts? {#manage-posts}

Clicking `Multi-location Business App` → `Social` → `Managed Posts` allows you to view Recent Posts. You can also view and edit Scheduled Posts, as well as retry any posts that may have failed. You can also see which locations are included in each post by clicking the locations link.

## How do I review brand performance across locations? {#overview}
...
<details>
<summary>Can I create Social Marketing campaigns at the multi-location-group level?</summary>

No. Campaign creation is not available at the multi-location-group level. Create campaigns from a single location instead.

</details>

<details>
<summary>Can AI customize content by location, and can I use Premium or Pro at HQ with Standard at branches?</summary>

Yes. You can customize content by location. Mixed editions are supported: an HQ account on Premium or Pro can post to Facebook, LinkedIn, Instagram, and Google Business Profile, while Standard branch accounts can post to Facebook and Google Business Profile.

</details>

<details>
<summary>Do I need to activate Social AI for every location?</summary>

Yes. Each location must have Social AI Standard or Pro for multi-location posts to publish to it. For best results, use one account per location with Facebook, Instagram, and Google Business Profile connected to that account's Social AI app.

</details>

<details>
<summary>What can I include in a multi-location post?</summary>

You can post to Facebook, Instagram, and Google Business Profile, including Google Business Events and Call To Actions. You can add dynamic content (business name, city, and phone number) so each location's details fill in automatically.

</details>

<details>
<summary>Can a location edit a multi-location post?</summary>

Yes. Each location can edit a scheduled multi-location post in Social AI in its own Business App, at `Social AI` → `My Posts` → `Scheduled Posts`. After a location edits its copy, you can't make bulk edits to that location's post from Multi-location Business App.

</details>

<details>
<summary>Do the Overview stats include posts made directly on social sites?</summary>

Yes. The new posts and engagement stats at the top of the Overview page include posts published through the platform and posts published directly on the connected social media sites.
