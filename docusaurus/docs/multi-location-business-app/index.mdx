...
sidebar_position: 1
description: "Multi-Location Business App lets your clients manage multiple business locations from one portal, with business groups, dashboards, and reports."
brand: vendasta
product: multi-location
audience: partners
content_type: overview
kb_id: KB-00120
answer_snippet: "Multi-Location Business App is a portal where your clients manage and monitor multiple store or service locations from one interface, with business groups, aggregated dashboards, and cross-location reports. It's included in the Premium and Custom subscription tiers."
...
Multi-Location Business App is a portal where your clients manage and monitor multiple store or service locations from one interface, with business groups, aggregated dashboards, and cross-location reports. It's included in the Premium and Custom subscription tiers.

## Get started with Multi-Location Business App

![Multi-Location Portal](./img/multi-location/overview-1.jpg)

Ready to set up Multi-Location Business App for your clients? Start with the [setup guide](./setup/getting-started) to configure business groups, import locations, and set up user permissions.

## What is Multi-Location Business App?

The Multi-Location Business App gives businesses with multiple locations one central place to work. It's white-labeled, and customers can use it to:
...
Multi-Location Business App gives your clients one place to see and manage all their locations instead of managing each location separately. This helps them keep visibility and control across all locations as they grow.
...
- **Aggregated Insights** - Aggregated metrics with individual location performance tracking
- **Unified Communications** - Manage customer interactions across all locations in Conversations
...
- **Manage customer communications** across all locations from Conversations
...
- **Conversations** - Manage communications across all locations in one place
...
### Analytics & reporting
- **Executive Report** - Reporting with location-specific and aggregated insights
- **Performance Tracking** - Individual location and cross-location performance comparisons
- **Data Exporter** - Data export for custom reporting and external integrations
...
- **[Partner Center Overview](/partner-center)** - Access admin controls and client management tools
...
No, the multi-location dashboard does not support custom product names. Instead, you'll see generic menu items such as `Reputation`, `Listings`, `Social`, and `Advertising`.
</details>
...
<details>
<summary><strong>What subscription tier do I need to access the Multi-Location Business App?</strong></summary>

The Multi-Location Business App is included in **Premium** and **Custom** subscription tiers only. It is not available on Free, Starter, Essentials, or Professional plans.

If you don't see the Multi-Location Business App in your Partner Center, your current plan likely doesn't include it. Contact your assigned Vendasta representative to discuss upgrading your subscription.

Once access is enabled, you can find the Multi-Location Business App by going to `Partner Center` → `Accounts` → `Multi-Location Groups`.
