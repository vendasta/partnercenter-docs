...
Citation data is powered by Reputation AI Pro, and the cards will appear for accounts with Reputation AI Pro active. Citations are also affected by Citation Builder and Listing Sync Pro products, which can help drive an increase in citations found.

If your client does not have Reputation AI Pro active, the citations card will not appear in their Executive Report.