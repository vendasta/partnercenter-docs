...
:::note
AI-assisted review responses are only available on the **Premium** plan. On the Professional plan, suggested responses are pre-written templates rather than AI-generated.
:::
...
## How suggested responses behave when reviews are edited

If a customer edits an existing review, the suggested draft response is refreshed for that same review based on the latest review text and star rating.

If a reply has already been posted for the original version of the review, a draft response is not shown in the review card.
...
<details>
<summary>Does editing a review set its status to needs response in Reputation AI?</summary>

No. Editing a review does not change its response status in the dashboard. The status stays as it was after the edit.
