...
| Get associated Contact from Company | Gets the Contact associated with a CRM company. | If one does not exist, an error is returned. | When a company is created, I would like to get the associated contact and begin and email campaign to them. |
