---
title: Categorize text with AI
description: Learn how to use the Categorize text with AI action to automatically classify text into categories you define, creating branching paths in your automation.
sidebar_position: 5
...
**Categorize text with AI** lets you drop an AI classification step into any automation. Give it text — a chat summary, a form submission, a webhook payload — and define your categories. The AI reads the input, picks the best match, and the automation branches accordingly. No code, no rules engine, no manual routing. Set it up in minutes and every inbound message, lead, or support request goes to the right team automatically.
...
2. Under **Advanced**, select **Categorize text with AI**
...
**Step 2 — Add the Categorize text with AI step**

- Under **Advanced**, select **Categorize text with AI**
