...
For more information about implementing these triggers, see [Getting Started with Automations](./getting-started-with-automations.mdx) and [Creating and Configuring Automations](./creating-and-configuring-automations.mdx).
