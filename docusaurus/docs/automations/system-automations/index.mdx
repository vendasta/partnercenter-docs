...
![System Automation](../templates/img/automations/system-automations/system-automations-1.jpg)
...
For more information, view this article: [Managing Your Automations](../my-automations/managing-automations.mdx)
...
![Copy system automation](../templates/img/automations/system-automations/system-automations-2.jpg)
...
![Copy of system automation](../templates/img/automations/system-automations/system-automations-3.jpg)

When you're ready to turn on the copied automation, you can do so by clicking the On/Off toggle at the top of the page.

![Toggle automation](../templates/img/automations/system-automations/system-automations-4.jpg)