...
<details>
<summary>How should I design a CRM follow-up automation?</summary>

Trigger on a clear event, such as opportunity creation or a defined pipeline stage change. Put the email or SMS sequence and its delays in the campaign, and let the automation handle enrollment, branching, pauses, and notifications. Prefer separate automations for separate goals over one deeply nested workflow.
