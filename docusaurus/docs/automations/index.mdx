...
Learn more about [Workflow Control Steps](./my-automations/workflow-control-steps.mdx).
...
- **[System Automations](./system-automations/)** - Pre-configured automations built by Vendasta
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px', marginTop: '20px' }}>
  <div style={{ padding: '20px', border: '1px solid #ddd', borderRadius: '8px' }}>
    ...
    <ul>
      ...
      <li><a href="./system-automations/">System Automations</a></li>
    </ul>
  </div>
  ...
  <div style={{ padding: '20px', border: '1px solid #ddd', borderRadius: '8px' }}>
    ...
    <ul>
      ...
      <li><a href="./my-automations/workflow-control-steps">Logic & Conditions</a></li>
    </ul>
  </div>
  ...
  <div style={{ padding: '20px', border: '1px solid #ddd', borderRadius: '8px' }}>
    ...
    <ul>
      ...
      <li><a href="./my-automations/automation-settings">Automation Settings</a></li>
    </ul>
  </div>
</div>
