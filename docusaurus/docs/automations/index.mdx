...
- **[Partner-made automation templates](./partner-made-automation-templates.mdx)** – Create and manage templates for your clients
- **[Visual Visitor template](./automation-template-create-companies-from-visual-visitor.mdx)** – Create CRM companies from Visual Visitor data
- **[Bulk actions](./bulk-actions.mdx)** – Run automation-powered actions on demand from CRM views
- **[Trigger an automation using Zapier](./trigger-automation-using-zapier.mdx)** – Connect Vendasta CRM to third-party systems via Zapier
