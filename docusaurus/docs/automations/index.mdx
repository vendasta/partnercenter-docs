...
- **[Automation Workflows for Invoices](./automation-invoice-workflows.mdx)** ? Managing invoice reminders and follow-ups
- **[Creating and Configuring Automations](./creating-and-configuring-automations.mdx)** ? Build and configure custom workflows
- **[Email Campaign Automations](./email-campaign-automations.mdx)** ? Automate email campaigns from triggers and conditions
- **[Sales and CRM Integration](./sales-and-crm-integration.mdx)** ? Integrate automations with CRM and sales
...
When a customer has a failed payment, receive a notification so you can follow up quickly. Use the **invoice status changed** trigger to automate reminders.
