...
**Common triggers:** Order created, invoice created, new lead added, product reaches a certain status, task completed, account created, user active in Business App, campaign email opened or clicked.
