...
<img src={require('./img/automations/minimap-canvas.png').default} alt="Automation canvas zoomed out to 30 percent, with the minimap in the bottom-left corner showing an overview of the whole workflow and a rectangle marking the current viewport" style={{width: '100%', border: '1px solid #e0e0e0', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)'}} />
