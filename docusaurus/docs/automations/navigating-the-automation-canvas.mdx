...
| **Minimap** | Shows a scaled-down overview of the whole workflow |
...
The minimap gives you a scaled-down view of the entire workflow, so you can see the overall shape of a long automation and where you currently are within it. Select the minimap icon at the bottom of the canvas toolbar to show or hide it.

This is most useful in automations with many branches, where the full workflow no longer fits on screen at a readable zoom level.
