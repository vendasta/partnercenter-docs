...
![Campaign Failed Error](../faqs/img/automations/faqs/campaign-failed-error.png)
...
![Market Contact Settings](../faqs/img/automations/faqs/market-contact-settings.png)
