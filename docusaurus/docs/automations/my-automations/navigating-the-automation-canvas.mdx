...
<img src={require('./img/automations/minimap-canvas.png').default} alt="Automation canvas with the minimap in the bottom-left corner, showing an overview of the whole workflow and a blue rectangle marking the part currently in view, with the zoom controls below it" style={{width: '70%', display: 'block', margin: '0 auto', border: '1px solid #e0e0e0', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)'}} />
...
- [Reusable workflows](./reusable-workflows.mdx) — Grouping and action sets
