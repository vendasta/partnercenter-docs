...
<img src={require('./img/find-custom-object-search-fields.png').default} alt="Find custom object step showing the custom object type selector set to Projects and a search field with External ID, the is operator, and a dynamic value from a previous step" style={{width: '100%', border: '1px solid #e0e0e0', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)'}} />
