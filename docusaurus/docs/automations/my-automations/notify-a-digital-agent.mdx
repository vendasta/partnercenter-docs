...
:::info
In blueprints and default automations, the recipient is locked to **Assigned fulfillment agent** and cannot be changed. This ensures the notification always reaches the right person regardless of which account the blueprint is applied to.
:::
