...
This article goes through the complete list of automation steps that can accompany each trigger. See the full list of triggers [here](./available-automations-triggers-list.mdx). We have a few video examples of how to configure these steps [here](#walkthroughs).
