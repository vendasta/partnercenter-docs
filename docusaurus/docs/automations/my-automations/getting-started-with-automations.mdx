...
You can find more ideas in this article: [Create a new automation](./create-new-automation.mdx)
...
- [Automation steps](./available-automation-steps.mdx)
- [Manually trigger an automation](./manually-triggered-automations.mdx)
