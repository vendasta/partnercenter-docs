...
<details>
<summary>Why can't I add an Action Set inside a Group?</summary>

For now, you are unable to add Action Sets within a Group because nesting groups within other groups is not supported.

</details>

<details>
<summary>Why can't I save Action Sets with if/else, end, and jump steps?</summary>

These steps are not available within Action Sets at this time.

</details>

<details>
<summary>Who can create an Action Set?</summary>

Any Admin with permission to create automations can also create and apply Action Sets when building an automation.

</details>

<details>
<summary>Can other users in my company use an Action Set that I created?</summary>

Yes, currently, any Action Set created by you can be used by other users within your company, as there are no restrictions to manage this.

</details>

<details>
<summary>Is this feature available in the Business App?</summary>

Yes, this feature is available in Business App as well.
