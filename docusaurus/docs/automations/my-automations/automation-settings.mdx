...
- **Stop that specific automation run:** If a step fails, the automation run will completely stop for that account. The automation will not move on to the next step of the workflow. You may manually resume the run from any step in the workflow from the [automation activity](./automation-activity.mdx) section.
...
#### Partner Center Admin notifications (FAQ)
...
When configuring automations there is a step option to send notifications to the Partner Center Admin.
