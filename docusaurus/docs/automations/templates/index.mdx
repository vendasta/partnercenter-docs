...
See [Automations overview](../index.mdx), [Automation triggers reference](../my-automations/automation-triggers-reference.mdx), and [Automation steps reference](../my-automations/automation-steps-reference.mdx) for the building blocks.
...
1. Go to `Partner Center` → `Automations` → `My automations`, click `Create automation`, and select `Blank Template`.

   ![Blank automation template](../my-automations/img/automations/my-automations/auto-assign-salesperson-blank-template.jpg)
...
2. Under **Start the automation when**, select **An account is created** and click **Save**. Add conditions only if you want to limit which accounts trigger the automation.
   ...
   ![Account created trigger](../my-automations/img/automations/my-automations/auto-assign-salesperson-trigger.jpg)
...
3. Click the **+** under the trigger, scroll to **Sales**, and select **Assign a salesperson** (or **Assign a sales team** for round-robin assignment across a team).
   ...
   ![Assign a salesperson step](../my-automations/img/automations/my-automations/auto-assign-salesperson-action.jpg)
...
- [Creating and configuring automations](../my-automations/creating-and-configuring-automations.mdx)
