...
- To learn more about how to use automation, check out this great article: [Getting started with automations](/automations/my-automations/create-new-automation). You can also find all of our [available triggers](/automations/my-automations/available-automations-triggers-list) and [available steps](/automations/my-automations/available-automation-steps) to learn what they do and how they work.
