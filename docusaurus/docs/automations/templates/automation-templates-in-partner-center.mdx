...
- To learn more about how to use automation, check out this great article: [Getting started with automations](../my-automations/getting-started-with-automations.mdx). You can also find all of our [available triggers](../my-automations/available-automations-triggers-list.mdx) and [available steps](../my-automations/available-automation-steps.mdx) to learn what they do and how they work.
