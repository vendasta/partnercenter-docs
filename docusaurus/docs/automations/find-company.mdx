...
<img src={require('./img/automations/find-company-search-fields.png').default} alt="Find company step showing search fields configuration with a Salesperson field, operator, and dynamic value from a previous step" style={{width: '100%', border: '1px solid #e0e0e0', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)'}} />
...
<img src={require('./img/automations/find-company-workflow-example.png').default} alt="Automation workflow showing a contact trigger, Find company step, If/else branch on Found, with a campaign on the Yes branch and a notification on the No branch" style={{width: '100%', border: '1px solid #e0e0e0', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)'}} />
