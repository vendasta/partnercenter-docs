...
## Navigate large workflows with the minimap

When an automation has many steps, use the minimap in the workflow editor to quickly move across the full workflow without scrolling through each branch manually.

### Use the minimap

1. Open an automation in the workflow editor.
2. Locate the minimap in the editor.
3. Click the area of the minimap you want to view, or drag the highlighted viewport.
4. Continue building or reviewing steps in that section of the workflow.

The minimap helps you keep context while editing complex automations and makes it easier to find specific actions in long workflows.
