...
When you are working with large automations, use the minimap in the automation editor to quickly understand the full workflow layout and move to the section you want to edit.

The minimap helps you:

- Keep track of where you are in large workflows
- Quickly locate distant action groups and branches
- Move around the workflow canvas more efficiently
