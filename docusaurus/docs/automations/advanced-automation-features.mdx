...
## Automation editor canvas tools

The toolbar on the right edge of the automation canvas holds tools for navigating and understanding a workflow. These tools only change what you see — they never change what the automation does.
