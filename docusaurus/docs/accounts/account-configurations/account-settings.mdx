...
![Account Settings Dashboard](./img/accounts/settings/settings-dashboard.jpg)
*Overview of account settings categories and configuration options*

![Business Profile Configuration](./img/accounts/settings/business-profile-config.jpg)
*Configuring business-specific settings including hours, service areas, and operational preferences*

![Integration Settings](./img/accounts/settings/integration-settings.jpg)
*Setting up and managing third-party integrations and system connections*