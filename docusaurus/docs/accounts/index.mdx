...
- **Invite users to accounts** for client access
- **Create user accounts** centrally from Manage Users
...
- **Enable customer access** and send onboarding or welcome emails
...
2. **Invite users** to their accounts with proper permissions
