...
sidebar_label: Customize Reports
...
You can configure the order of Executive Report sections and hide or show sections on a market-by-market basis. This allows your client-facing reporting to focus on the areas where you provide value and avoid drawing attention to metrics that aren't part of your solution set.

![Customize Executive Report Sections Interface](../../business-app/executive-report/img/customize-executive-report-hide-show-reorder.png)
...
- **Google Search Console Prompt** - Allow your clients to connect Google Search Console in SEO section

### Report sections (drag to reorder and toggle visibility)
...
- **Market A** could specialize in SEO and Website services
- **Market B** could focus on Reputation AI and Social Media
- **Market C** could offer a full-service package
...
- **End with growth opportunities**: Position sections that encourage action (like "Connect your Google Business Profile") toward the bottom
...
Multi-Location Executive Reports are managed separately under `Partner Center` → `Accounts` → `Multi-Location Groups` → [Group Name] → `Features`. Toggle `CRM & Conversations` on or off there to control whether that section appears in multi-location reports.
</details>
