...
Allows you to trigger a specific automation for each account within the List. There are a number of useful ways you can utilize automations within Lists. See the [Manual triggers](../../automations/automation-triggers-reference.mdx#manual) section of the automation triggers reference.
