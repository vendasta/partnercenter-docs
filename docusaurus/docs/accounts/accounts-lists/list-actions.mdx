...
The following administrative actions are available from **Partner Center > Accounts > [Account Lists](https://partners.vendasta.com/action-lists/manage)** by clicking the **Menu** icon ![Menu icon](./img/accounts/lists/menu-icon.png) next to the Account List.
