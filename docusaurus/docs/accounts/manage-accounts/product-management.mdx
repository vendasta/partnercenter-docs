---
title: "How do I manage products for an account?"
sidebar_label: Manage Products
sidebar_position: 5
description: "Activate products for a Partner Center account, change product editions, and cancel products or schedule their deactivation."
...
content_type: how-to
kb_id: KB-00182
answer_snippet: "In Partner Center, you manage an account's products from the Products card on the account Overview in Accounts → Manage Accounts. From there you can activate products, change editions, and cancel a product or schedule its deactivation."
...
In Partner Center, you manage an account's products from the `Products` card on the account Overview in `Accounts` → `Manage Accounts`. From there you can activate products, change editions, and cancel a product or schedule its deactivation.
...
## How do I activate products? {#how-to-activate-products}

### How do I activate products from an account? {#activating-products-through-account}
...
### How do I activate products from the CRM? {#activating-products-through-crm}
...
### How do I build my product catalog? {#building-your-product-catalog}
...
## How do I change a product edition? {#change-product-editions}
...
## How do I cancel a product? {#cancel-products}
...
## How do I handle product cancellations? {#how-to-handle-product-cancellations}
