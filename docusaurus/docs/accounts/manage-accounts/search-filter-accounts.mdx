...
sidebar_position: 4
description: Find accounts by name, address, phone number, or business details, and filter them by product, location, category, or date
...
2. Click the bookmark icon, then click `Save this filter`
...
To export accounts from a list:

1. Navigate to the account list you want to export
...
Yes. You can save filter combinations as named views in Partner Center for quick access without reconfiguring each time.
