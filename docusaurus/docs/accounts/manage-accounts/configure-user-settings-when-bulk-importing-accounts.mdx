...
You can configure user notification and permission settings when [bulk importing accounts](/accounts/accounts-manage-accounts/bulk-import-accounts). After uploading a CSV file with account and user data, you can determine whether new users can:
