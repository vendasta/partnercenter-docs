---
title: "How do I delete an account in Partner Center?"
sidebar_label: Delete accounts
sidebar_position: 6
description: "Delete a business account in Partner Center, what deletion removes, how billing commitments continue, and alternatives such as deactivation."
...
content_type: how-to
kb_id: KB-00197
answer_snippet: "To delete an account in Partner Center, go to Accounts → Manage Accounts, open the account, click Edit Account, and click Delete Account at the bottom of the form. Deletion is permanent and removes all of the account's data."
...
To delete an account in Partner Center, go to `Accounts` → `Manage Accounts`, open the account, click `Edit Account`, and click `Delete Account` at the bottom of the form. Deletion is permanent and removes all of the account's data.
...
## How do I delete an individual account? {#how-to-delete-individual-accounts}
...
- Billing does not stop: products on active commitments keep billing until the commitment period ends

## How do I handle account deletion requests? {#how-to-handle-account-deletion-requests}
...
## What are the alternatives to deleting an account? {#alternatives-to-account-deletion}
...
## How do I clean up duplicate accounts? {#how-to-manage-duplicate-account-cleanup}
...
## What should I back up before deleting an account? {#data-recovery-and-backup-considerations}
