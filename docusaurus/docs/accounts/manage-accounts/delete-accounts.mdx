...
![Account Deletion Warning](./img/accounts/delete-account-warning.jpg)
*The account deletion interface showing safety warnings and confirmation requirements*

![Deletion Confirmation](./img/accounts/delete-confirmation.jpg)
*Confirmation dialog requiring business name input to prevent accidental deletions*

![Account Status Options](./img/accounts/account-status-options.jpg)
*Alternative options to deletion including deactivation and archiving*