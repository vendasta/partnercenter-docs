...
*Starting the account creation process from the Manage Accounts dashboard*

![Business Search Interface](./img/accounts/create-account/search_business.jpg)
*Searching for businesses with automatic data population from public directories*

![Manual Account Creation Form](./img/accounts/create-account/competitor_selection.jpg)
*Completing business profile information for manual account creation*