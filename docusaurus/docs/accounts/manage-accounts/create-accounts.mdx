...
You’ll see these options during the import wizard after mapping fields. Bulk import sends the classic welcome email only — it does not send the [onboarding email](/business-app/ai-onboarding-experience).
