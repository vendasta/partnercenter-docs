...
![List Management Dashboard](./img/accounts/lists/list-management-dashboard.jpg)
*Overview of list management interface showing organization and maintenance options*

![Add Remove Accounts](./img/accounts/lists/add-remove-accounts.jpg)
*Interface for adding and removing accounts from existing lists*

![List Settings Configuration](./img/accounts/lists/list-settings.jpg)
*List configuration options for updating criteria, permissions, and organization*