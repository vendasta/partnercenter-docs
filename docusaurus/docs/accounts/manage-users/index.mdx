...
5. Enter the required details (email address, name, and other requested fields). The **Send welcome email** checkbox is selected by default; clear it if you don't want the user notified immediately.
...
2. Click **Create user**.
3. Fill in the user information (email address, name, and other required fields). The **Send welcome email** checkbox is selected by default; clear it if you don't want the user notified immediately.
