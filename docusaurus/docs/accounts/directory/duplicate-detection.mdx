...
Account deletion is typically permanent, so contact Vendasta Support immediately. Some systems may have backup or recovery options, but it's better to prevent this by carefully verifying which account to preserve before deletion.
</details>
