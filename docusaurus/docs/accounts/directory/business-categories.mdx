...
## Complete business categories list

📋 **[Download Complete Business Categories CSV](./downloads/business-categories-list.csv)**

The complete list of all available business categories (over 4,000 categories) is available as a downloadable CSV file containing:
- **Category Name**: Human-readable business category name
- **External ID**: System identifier used for API integration and bulk imports

:::tip Using the Categories List
- Use the **Category Name** when manually selecting categories in the interface
- Use the **External ID** for bulk imports, API integration, or automated processes
- Categories range from broad classifications (e.g., "Restaurant") to highly specific (e.g., "Korean Barbecue Restaurant")
:::
