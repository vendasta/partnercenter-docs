...
![Business App URL Location](./img/accounts/business-app/app-url-location.jpg)
*Finding the Business App URL in customer account details*

![Customer Dashboard View](./img/accounts/business-app/customer-dashboard.jpg)
*Example of customer-facing Business App dashboard with reports and features*

![Access Configuration](./img/accounts/business-app/access-configuration.jpg)
*Configuring Business App access settings and feature visibility for customers*