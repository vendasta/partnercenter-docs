...
You can switch between individual locations within MLBA using the location switcher. Permissions can be set at the group or location level to control access to analytics and reporting data.
