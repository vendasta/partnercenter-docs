...
### How to Set Up “Contact Sales” as a Purchase Option Instead of Displaying Product Prices

You can configure your store to show a **“Contact Sales”** option instead of displaying the price for individual products. This allows potential customers to reach out directly to your sales team for customized pricing or package details.

### Important Note
- The **“Contact Sales”** option can only be applied when you create a **package** that includes the individual product.
- It **cannot** be enabled for products directly available in the **My Products** section of the Store.

### Steps to Enable “Contact Sales” option
