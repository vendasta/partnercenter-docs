...
## What is Store Setup & Configuration?
...
## Why is Store Setup & Configuration important?

A well-configured store drives better business results:

- **Direct customer purchases**: Customers can buy without sales intervention
- **Brand consistency**: Maintain visual identity across all touchpoints
- **Revenue growth**: Optimized design increases conversion rates and order values
- **Scalability**: Automated processes reduce administrative overhead
- **Customer satisfaction**: Intuitive navigation improves user experience

## What's Included with Store Setup & Configuration?

### Product Foundation
- Browse and enable products from the marketplace
- Configure custom products and services
- Set up recommended and custom packages
- Manage product availability by market
...
1. Go to **Partner Center > Marketplace > Discover Products**
2. Browse categories and evaluate product details
3. Click **Start Selling** on products that fit your market
4. Products automatically include all editions and add-ons
5. Access **Marketplace > Packages** to create bundles

**Benefits**:
- No upfront costs (pay only when customers purchase)
- Immediate store availability
- Access to marketing materials
- Flexibility to modify pricing anytime

### 2) Configure product settings
Go to **Partner Center > Marketplace > Products** to:

1. **Adjust pricing**: Click lock icon to modify retail prices
2. **Set billing frequency**: Change cycles (wholesale billing unchanged)
3. **Enable auto-activation**: Toggle for Standard products
4. **Configure white-label branding**: Customize names and icons
5. **Set upgrade paths**: Design customer progression options
6. **Manage team access**: Control internal access levels
...
### Visual theme
Navigate to **Partner Center > Marketplace > Manage Store > Theme** to customize:

**Colors**:
- Logo bar (top section with logo and auth buttons)
- Background (store background or transparency)
- Accent colors (button text and category tabs)
- Primary category (main navigation and package names)
- Secondary category (pricing and secondary info)

**Typography**:
- Primary font (package names, categories, main descriptions)
- Secondary font (price information and supplementary text)

**Advanced options**:
- Transparent background for website integration
- Real-time preview of changes
- Brand consistency alignment

> Public Store theme customizations do not affect Business App Store appearance.
