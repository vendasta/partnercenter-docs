...
- **Line-Item Pricing Model** - Package uses the current line-item pricing model
...
- **Not Yet Migrated** - Packages that have not been opened and saved in the package constructor since the line-item pricing model was introduced. To migrate, edit the package in the constructor, review the pricing, and save. The migration happens automatically on save.
