...
**Public Store and Business App synchronization:** Any packages visible in your Public Store are also visible in your Business App store for that selected market.
