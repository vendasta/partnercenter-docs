...
Yes, products can be disabled by navigating to Partner Center > Makretplace > Discover Products, search and select the product, then scroll to the bottom of the product details page to find the "Stop Selling" button. 
