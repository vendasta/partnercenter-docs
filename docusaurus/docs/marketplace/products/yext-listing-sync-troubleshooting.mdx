...
<details>
<summary>Why might an account show no active Yext subscription after migration from Yext?</summary>

If the account did not have an active Yext subscription at migration, no Yext license appears afterward. When the account needs a Yext license for listing sync, activate Vendasta's Yext SKU.
