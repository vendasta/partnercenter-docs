---
title: "How do I create and manage my own products?"
sidebar_label: "Create & Manage Custom Products"
sidebar_position: 2
description: "Create your own products in Marketplace and Vendor Center: pricing, editions, activation, order forms, trials, marketing, integrations, and add-ons."
...
content_type: how-to
kb_id: KB-00090
answer_snippet: "You can create your own products in Marketplace at Marketplace → Products → Create Product. Enter the basic information, pricing, and marketing content, then publish the product or continue editing it in Vendor Center for advanced settings."
...
You can create your own products in Marketplace at `Marketplace` → `Products` → `Create Product`. Enter the basic information, pricing, and marketing content, then publish the product or continue editing it in Vendor Center for advanced settings.

In addition to the 250+ solutions you can resell, the marketplace lets you create, market, sell, bill, and fulfill your own products and services. This guide covers quick creation through advanced management.

## Why create your own products?

**Expand your service portfolio**
- Use marketplace infrastructure
...
## How do I create a product? {#product-creation-methods}

### How do I create a product quickly? {#quick-start-product-creation}
...
### How do I use advanced product creation? {#advanced-product-creation}

For full product setup with access to all features, use Vendor Center for advanced configuration options.

Access: Through **Vendor Center** for advanced configuration.


## What can I configure in the Product info tab? {#product-info}
...
#### How do I auto-activate a product when a new account is created? {#auto-activating-a-product-when-a-new-account-is-created}
...
### How do I offer a free trial? {#free-trial-management}
...
## How do I customize my product's marketing? {#marketing}
...
## How do I integrate my product with external systems? {#integration}
...
### Task Manager/Fulfillment integration {#task-manager-integration}

Standardize your fulfillment process by automating project and task creation in Task Manager/Fulfillment. Toggle **Integrate with Task Manager** to activate.

- **Projects** — Automatically create a project in Task Manager/Fulfillment each time this product is purchased. Select a project template and choose who fulfills it:
  - *Vendor* — Create projects in your Task Manager/Fulfillment.
  - *Reseller* — Create projects in the reseller's Task Manager/Fulfillment.
...
## How do I create add-ons? {#add-ons}
...
## How do I compare or suspend my product? {#compare-product}
...
## Why don't custom products have Start Selling or Stop Selling buttons? {#custom-products-and-the-startstop-selling-buttons}
...
<details>
<summary>How do I automatically activate a product when a new account is created?</summary>

Go to `Partner Center` → `Administration` → `Customize` → `Account Creation`, and add your custom product under **Products to activate on account creation**. The product activates on every new account without requiring a separate order.

</details>

<details>
<summary>Why isn't Auto Activation working for my product?</summary>

Auto Activation only works if the product has no Order Form configured. If an Order Form is attached, the order must be manually processed so the form can be completed. Remove the Order Form first if you want auto activation to apply.

</details>

<details>
<summary>How do I stop a custom product from being ordered?</summary>

Use **Suspend new activations** in the **Compare product** tab of Vendor Center. This prevents new customers from activating the product while keeping it available for existing users. Custom products don't have **Start Selling** or **Stop Selling** buttons.

</details>

<details>
<summary>How do I offer a free trial for my product?</summary>

Toggle **Offer a trial period**, set the **Duration** in days, and choose what happens **At end of trial**: **Do nothing** keeps the product active, and **Deactivate** deactivates it when the trial ends.

</details>

<details>
<summary>Can my product send customers to a URL after they purchase it?</summary>

Yes. In the **Access and SSO** section of the **Integration** tab, choose an **Access type** such as **Public webpage** or **Activation-specific URL**, and enter the **Product access URL** that users are redirected to when they launch your product.
