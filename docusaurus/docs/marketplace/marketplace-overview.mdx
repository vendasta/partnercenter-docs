...
- **Streamlined sales**: One place to sell, deliver, and fulfill products
- **Product‑led growth**: Let clients explore and self‑order without sales time
- **Revenue growth**: Resell 250+ products with one click using a white‑label store
- **Centralized management**: Track metrics, set pricing, and manage purchases from one dashboard
...
### Manage Store
- Customize your white‑label store theme, appearance, and settings
...
### Packages
- Bundle products into value‑based offers at different price points
...
To make a product visible and available in your store, follow these steps:

1. Navigate to `Marketplace → Products`.  
2. Find the product you want to add to your store. You can use the search bar or scroll through the list of available products.  
3. Open the product details page by clicking on the product name.  
4. In the **“Available in store”** section (right-hand side), toggle the checkbox next to the desired market(s) to **“Yes.”**  
5. Your changes are saved automatically — the product will now appear in your store for the selected markets.
