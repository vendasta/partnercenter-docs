...
description: "Message clients, vendors, and Vendasta support from Conversations in Partner Center, and use the AI web chat widget and message templates."
sidebar_position: 7
...
kb_id: KB-00029
answer_snippet: "Conversations in Partner Center is where you and your team send and receive messages with your clients in Business App, marketplace vendors, and Vendasta representatives. It also includes a complimentary AI-assisted web chat widget that captures leads from your website."
...
Conversations in Partner Center is where you and your team send and receive messages with your clients in Business App, marketplace vendors, and Vendasta representatives. It also includes a complimentary AI-assisted web chat widget that captures leads from your website.
...
Start messaging clients through Partner Center and enable your complimentary [AI-assisted web chat widget](./ai-assisted-web-chat-widget.mdx) for lead capture.

## What is the Conversations feature?

Conversations gives you one place to send and receive messages with your clients, vendors, team members, and Vendasta. In Conversations, you can:
...
- **Always available** - Notifications help you avoid missed messages
...
### Core features
- **[Conversations in Partner Center](./conversations-in-partner-center.mdx)** - Messaging setup and usage
...
- **Notification Management** - Alert and reminder settings
...
- **Handoffs**: Any team member can pick up and continue conversations
...
No. Conversations access in Partner Center is all-or-nothing: a user either has access to all conversations or none. There is no way to filter a user's view to only their assigned market's conversations. If you need to limit access, the only option is to remove Conversations access entirely for that user.
</details>
