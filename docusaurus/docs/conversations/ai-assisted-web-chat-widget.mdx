...
Select your website platform to see specific installation instructions.

<Tabs>
  <TabItem value="godaddy" label="GoDaddy">

#### Install the web chat widget on GoDaddy Website Builder

1. In Partner Center, go to **Conversations ? Settings ? Web Chat Configuration**.
2. Select the **GoDaddy Website Builder** tab in the **Installation** section.
3. Copy the custom Javascript code.
4. In your GoDaddy Website Builder, use the option to add **custom code** or an **HTML section** to your site.
5. Paste the code, then save and publish your changes.
...
1. In Partner Center, go to **Conversations ? Settings ? Web Chat Configuration**.
2. Select the **WordPress** tab in the **Installation** section.
3. Download the installation plugin ZIP file.
4. In your WordPress admin, go to **Plugins ? Add New Plugin** and upload the ZIP file.
5. Activate the plugin.

  </TabItem>
  <TabItem value="other" label="Other Platforms (HTML)">

#### Install the web chat widget manually

1. In Partner Center, go to **Conversations ? Settings ? Web Chat Configuration**.
2. Select the **Installation** tab.
3. Copy your web chat installation code.
4. Paste the code into the `<head>` section of your website, just before the closing `</head>` tag.
