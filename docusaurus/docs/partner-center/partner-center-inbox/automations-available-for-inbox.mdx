---
title: Automations available for Inbox
description: The Vendasta platform automations system has triggers and actions that can affect Inbox messaging. Some of these triggers and actions are...
sidebar_position: 4
---
...
[Manage your automations.](https://partners.vendasta.com/automations)
...
Find templates in the [Create workflow](https://partners.vendasta.com/automations/create) in automations.
