...
## Omni‑Search overview

Use hotkeys in Partner Center to speed up navigation:

- Press `/` to open Omni‑Search
- Press `B` to search for a business
- Press `U` to search for and impersonate a business user or salesperson

![Partner Center Omni‑Search interface](./img/partner-center-overview/partner-center-omni-search.png)

## Understanding the AGID

The Account Group ID (AGID) uniquely identifies a business account in the platform.

### Finding the AGID

Navigate to Partner Center > Accounts > Manage Accounts > select an account. In the Business Details card, the AGID appears at the bottom‑right.

![Business details showing AGID](./img/partner-center-overview/account-group-id-business-details.png)

### Using the AGID

Use the AGID when searching for accounts or when providing context in support requests.

![Searching by AGID](./img/partner-center-overview/account-group-id-search.png)
...
Outside of that, we do not currently auto-uplift those certificates in the individual apps such as Reputation AI and Local SEO as they would be behind those login portals.
...
<details>
<summary>How do I find my Partner ID (PID)?</summary>

Your Partner ID (PID) is a 4-character identifier (numbers and/or letters) that uniquely identifies your Partner Center account. You can find it in the top left-hand corner of your Partner Center dashboard.
