...
If you're new to the platform, we highly recommend following our [Getting Started Guides](/partner-center/getting-started-guides) and taking courses in the [Vendasta Academy](https://academy.vendasta.com/).