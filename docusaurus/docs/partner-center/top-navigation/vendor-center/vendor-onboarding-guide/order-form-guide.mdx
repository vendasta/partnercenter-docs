...
Order forms allow you to request specific business information from partners when activating the app. There are also [Fulfillment Forms](/partner-center/vendor-center/vendor-onboarding-guide#6--fulfillment-forms-), that allow for information to continue to be collected after the purchase is made. Both the standard Order Form, and Fulfillment Form utilize the same form builder.
...
- To obtain Reseller or client contact information for fulfillment communication. Note: Automated communications should be handled through the platform. Use the [Inbox](https://support.vendasta.com/hc/en-us/articles/11486192568855-Vendor-Onboarding-Getting-Started-Guide#:~:text=with%20the%20Vendor.-,Platform%20Inbox,-Vendasta%20provides%20a) for general Reseller communication.
