...
![Requests Menu Item](./img/tracking-request-performance/requests-menu.jpg)

2. Select "Performance" from the submenu

![Requests Performance Submenu](./img/tracking-request-performance/requests-submenu.jpg)

## Understanding the Metrics

The Performance page displays an overview of request performance metrics for all locations within the business:

![Metrics Overview](./img/tracking-request-performance/metrics-overview.jpg)
...
![Location Metrics](./img/tracking-request-performance/location-metrics.jpg)
...
![Filter Options](./img/tracking-request-performance/filter-options.jpg)
