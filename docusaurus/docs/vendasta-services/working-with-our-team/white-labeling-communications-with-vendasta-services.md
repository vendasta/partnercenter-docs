...
![](./img/22219444306583-e8e08b4599.png)

## White-Label Email Option:

Integrate a custom white-labeled email address into our ticketing system for personalized communication. Follow these steps:

1.  **Provide the following:**
    1.  Chosen **email address** (e.g., [marketingservices@yourdigitalagency.com](mailto:marketingservices@yourdigitalagency.com))
    2.  **Login credentials for the email inbox** (Gmail, Outlook, etc.)
    3.  **Login credentials for the domain registrar** (GoDaddy, Wix, Namecheap, etc.)
        1.  _If your domain is with GoDaddy, you can instead grant us delegate access to_ [_websites@yourdigitalagents.com_](mailto:websites@yourdigitalagents.com) 
...
3.  **Email Integration Confirmation:**
    1.  You’ll receive an email confirmation to the provided personal contact email.
    2.  Settings updated will be included for your reference.

**Important Note:**

Any alterations to settings may cause integration issues. To undo integration, contact us at [marketingservices@yourdigitalagents.com](mailto:marketingservices@yourdigitalagents.com), and we'll assist you promptly.
