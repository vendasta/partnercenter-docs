...
Once the product is activated, it will kick off a project that can be tracked in your client’s Business App. Our team will process the order and book an onboarding call with the contacts provided during the activation to go over the expectations and discuss required assets and design choices. Check out [this article](https://marketing-services.zendesk.com/hc/en-us/articles/19128976174103) to learn tips and tricks for ordering websites—and other services—with Marketing Services.
