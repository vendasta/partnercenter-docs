...
Our products don’t have “Marketing Services” in the title, so you may not recognize them at first glance. Below are 2 ways to easily identify our products while searching in the Marketplace alongside other vendors.
...
4.  Within the table, click on the blue “**Add filter**” button and navigate to the following filter to apply it:
    1.  **Vendor** > **Marketing Services** 
    2.  Click “**Apply.**”  
          
        
5.  With this filter applied, the table will now display all of the available products and services fulfilled by Marketing Services.

### Recognizing Product Logos

Aside from using the product filters, you can recognize Marketing Services products amidst your search results by our distinct product logos.

Marketing Services products feature a distinct grey circular logo, with a colored ring on the border (colors vary) and a white icon in the center.
...
_Still have questions? Marketing Services product-related queries can be directed to us via email at_ [_marketingservices@yourdigitalagents.com,_](mailto:marketingservices@yourdigitalagents.com) _and we’ll be happy to help!_
