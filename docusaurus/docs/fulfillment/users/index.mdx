...
title: Users
sidebar_label: Users
description: Complete guide to managing users, groups, notifications, and permissions for team collaboration in Task Manager.
...
User management allows you to create, organize, and manage team members who will collaborate on projects and tasks. The system includes user creation, group organization, notification management, and permission control to structure your fulfillment team effectively.

## Why is User Management important?

As companies grow, there's an increased need for structure. People begin to specialize, teams form, and work is divided. Most larger agencies feature complex hierarchies of people. User management ensures the right person does the right job by matching your task management software to how your organization works in the real world.
...
1. Go to **Partner Center** → **Fulfillment** → **Task Manager**
...
- **Task Assignee Update**: Get notified when an existing task is reassigned to you
...
Task Manager users receive both in-app notifications and emails for **Task Assignee Update** when an existing task is reassigned to them. This notification does not trigger when a new task is assigned during task creation. Clicking the notification or email link takes you directly to the task in Task Manager.
</details>
