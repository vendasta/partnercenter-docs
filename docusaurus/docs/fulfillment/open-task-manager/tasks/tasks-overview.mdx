...
This notification setting can be found in the bell icon of Partner Center under the "Tasks" section. When activated, it will notify you when an existing task is re-assigned to you.
It will not send a notification when a user assigns a new task to you upon creation.
</details>