...
If you have not yet performed an action, you can also manually create an account in Task Manager so you can begin using the account. If you haven't yet, you can [create accounts in Partner Center](/fulfillment/partner-center/create-accounts-in-partner-center).
...
:::note
By default, this will put the account into an [active state](/fulfillment/open-task-manager/account-settings). This can be changed under **Settings > Account settings.**
:::