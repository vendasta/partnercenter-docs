...
- **Social Calendar Generation**: Automatically generate and schedule social post tasks within the project
- **Client Review**: Require client approval before content goes live

#### Social Calendar Generation defaults

When you use **Social Calendar Generation** in a Social Calendar project, these defaults are pre-configured:
...
- **Day of week:** **Monday**
- **Time:** **9:00 AM**
- **Timezone:** Automatically populated from the SMB timezone in Business App
- **Start date:** Current date
- **End date:** **No end date**
- **Availability:** Web and mobile
- **Applies to:** **Social Media Manager**
...
1. Enter a descriptive name for your task in the **Task Name** field
