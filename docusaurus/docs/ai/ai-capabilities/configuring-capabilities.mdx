...
Before you begin:
- You have an AI Employee created
...
- Prerequisites: Ensure your calendar is connected in settings
- Recommended instructions:
  ```
...
Need help with specific capability configurations? Check our troubleshooting guide above or contact support for assistance.
