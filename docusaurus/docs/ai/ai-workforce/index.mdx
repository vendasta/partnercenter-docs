...
AI Employees all share a similar structure—no matter what role they play in your business. This applies to pre-built AI Employees (e.g., Chat Receptionist, Voice Receptionist) and Custom AI Employees you create. Each one comes with common parts you can review and configure, such as their name, purpose, communication channels, capabilities, and what knowledge they use to answer questions. 
