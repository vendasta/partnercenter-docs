...
## Default trigger settings for Social Premium

When Social Premium is activated, the Social Media Manager and Blogger AI Employees are configured with default trigger settings for weekly content generation:

- **Frequency:** Weekly
- **Day of the week:** The day the product was activated
- **Time:** 9:00 AM
- **Timezone:** The account's business timezone, or Chicago time if no business timezone is available
- **Start date:** The product activation date
