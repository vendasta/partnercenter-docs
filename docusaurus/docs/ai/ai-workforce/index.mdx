...
> **Note:** Most standard business needs (like appointment booking or lead capture) are handled by built-in capabilities that already have tools configured. Custom tools are for specialized integrations specific to your business.
