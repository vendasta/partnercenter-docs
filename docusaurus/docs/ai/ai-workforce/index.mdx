...
## Social Marketing AI employees in Business App

For businesses using Social Marketing, the **AI Workforce** page in Business App includes these AI employee cards:

- **Social Media Manager** - Creates and publishes social media content aligned to your brand voice and goals.
- **Blogger** - Creates SEO-friendly blog posts based on your services, promotions, and customer search intent. The card displays a **Coming Soon** badge and is not available for setup.

The **Blogger** card appears after **Social Media Manager**.
