...
- **Business Profile**: Automatically included (business hours, services, contact info, and listing attributes such as accessibility and amenities)
...
For details on automation integration, see [Advanced Automation Features](../../automations/advanced-automation-features.mdx).
...
Yes! You can add Custom AI Employees to automation workflows using the "Send a prompt to an AI Employee" step. This allows you to use AI-powered decision-making in your automated processes. For more details, see [Advanced Automation Features](../../automations/advanced-automation-features.mdx).
