...
kb_id: KB-00063
answer_snippet: "The AI Sales Assistant is an AI Workforce employee in CRM AI that automatically updates your CRM records after recorded meetings, creates activities, and answers questions about your CRM data through chat. It's included with CRM AI Standard and Pro."
...
The AI Sales Assistant is an AI Workforce employee in CRM AI that automatically updates your CRM records after recorded meetings, creates activities, and answers questions about your CRM data through chat. It's included with CRM AI Standard and Pro.

It uses your CRM data and meeting records to keep your CRM up to date and answer your questions.
...
## What's included with the AI Sales Assistant? {#whats-included-with-the-ai-sales-assistant}
...
## How do I set up the AI Sales Assistant? {#how-to-set-up-the-ai-sales-assistant}
...
## Which CRM AI editions include the AI Sales Assistant? {#crm-ai-editions}
...
You can configure the AI Sales Assistant from `AI` → `Workforce`. To use the chat interface, click the `AI icon` in the top right of the CRM screen.
...
The AI Sales Assistant processes meeting content in English. It uses English-language meeting transcriptions and summaries to update CRM records and generate insights.
...
<div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', background: 'rgba(60, 154, 99, 0.08)', border: '1px solid rgba(60, 154, 99, 0.35)', borderRadius: '8px', padding: '14px 18px', margin: '16px auto', width: 'fit-content', maxWidth: '100%', textAlign: 'center'}}>
  ...
  <span style={{fontSize: '14px', color: 'var(--ifm-font-color-base)', textAlign: 'center'}}>
    New to prospecting and closing? Take <a href="/learn/sales" style={{color: '#3C9A63', fontWeight: 600}}>The master sales series</a> in Vendasta Learn — Beginner to Intermediate, 5 lessons.
  </span>
</div>
