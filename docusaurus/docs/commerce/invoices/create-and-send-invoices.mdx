...
- You have created [tax rates](/administration/commerce/tax-rates/tax-rates) (if applicable)
...
- Use the Options **⋮** menu to remove an item from the invoice or [apply a tax rate](/administration/commerce/tax-rates/tax-rates) to a line item.
