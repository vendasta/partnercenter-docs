...
| --- | --- |
| I have some customer accounts set to "bill by active." | Your accounts set to "bill by active" will be automatically transitioned to Subscriptions. No action is needed. |
| I have some customer accounts set to "bill by active," but I also have some customer accounts billed through recurring invoices. | There have been no changes made to accounts with recurring invoices, but you can switch them to Subscriptions if you want. Simply follow the Subscription billing step-by-step setup guide. |
| I have never used "bill by active" on any account. How does this impact me? | There is no impact to you at this time. Subscription billing is currently released to partners who have at least one customer account on "bill by active." However, Subscriptions will be coming to you soon! |
| When I add a new customer account, what should I do if I want to use subscription billing? | You can set the default market setting to enable Subscription billing on all new accounts. You can also enable Subscription billing on a per-account basis. Simply follow the Subscription billing step-by-step setup guide. |
| After I activate a product or service, what should I do if I want to use subscription billing? | <ol><li>Check that the product has been successfully activated on the customer account.</li><li>Validate the retail subscription by going to the subscriptions page on the customer account:
  <ul>
    <li>Validate the price.</li>
    <li>Validate that there are no duplicates.</li>
    <li>Validate that any product that failed to activate is not added to the subscription. If so, follow the subscription cancellation steps.</li>
  </ul>
</li><li>Check the invoicing settings (billing settings) to be sure it is set up correctly.</li><li>Preview next invoice.</li></ol><br />And you're all set to go. |
