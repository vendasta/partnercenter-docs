...
| After I activate a product or service, what should I do if I want to use subscription billing? | 1. Check that the product has been successfully activated on the customer account.
2. Validate the retail subscription by going to the subscriptions page on the customer account.
   1. Here you can validate the price.
   2. Validate that there are no duplicates.
   3. Validate that any product that failed to activate is not added to the subscription. If so, follow the subscription cancellation steps.
3. Check the invoicing settings (billing settings) to be sure it is setup correctly.
4. Preview next invoice.
