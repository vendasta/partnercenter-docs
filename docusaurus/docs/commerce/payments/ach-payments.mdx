...
2. Your agency is based in the US, serving clients also located in the US.
...
3. Depending on the options you've selected, your client will see one or multiple payment options. With the ACH option, they will see `US Bank Account`. 
