...
A credit note is a document you issue to a client to decrease the amount on a due or paid invoice. This may be necessary due to a mistake on an order or invoice, or to refund an amount paid for products or services. A credit note acts as the opposite of an invoice, reversing the amount owed by the client to you.

![Credit note example](./img/commerce/credit-notes/credit-note-1.png)

## Common reasons to issue credit notes

- Accidental over-billing of a client.
...
A credit note is a document you issue to a client to reduce the amount owed on an invoice. It acts as a reversal of the original invoice amount and is typically issued due to billing errors, refunds, discounts, or compensations.
...
You commonly issue credit notes for reasons such as accidental over-billing, compensating a client for a mistake or inconvenience, responding to a client's request for a refund, or offering a discount on a due or paid invoice.
...
Credit notes maintain a record of all reverse transactions, which is essential for accurate financial reporting and reconciliation of accounts. They ensure transparency and clarity in financial transactions between you and your clients.
...
<details>
<summary>Do retail credit notes for partner-to-client transactions apply to future payments?</summary>

No, retail credit notes for partner-to-client transactions currently do not apply to future payments.
...
No, credit notes are not automatically sent when applied. You have the option to send the credit note to the client if you choose.
...
No, but refunds over $1000 will require Support on-Demand to issue the refund. Please submit refund requests for your clients over $1000 to support@vendasta.com.
