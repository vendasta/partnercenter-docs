...
<details>
<summary>What payment methods are supported for order payments?</summary>

Partner Center supports credit and debit cards (Visa, Mastercard, American Express, Discover), ACH transfers, and Pre-Authorized Debits (PADs) for secure payment collection within the order workflow.
</details>
