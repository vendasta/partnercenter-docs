...
:::note Orders created automatically through Business App
Orders that are created automatically through Business App can't be edited once they reach **Scheduled activation** status—line items, prices, and the start date are locked. You can still cancel these orders if needed.
:::
