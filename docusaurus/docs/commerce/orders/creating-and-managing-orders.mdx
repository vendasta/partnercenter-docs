---
title: "How do I create and manage orders in Partner Center?"
sidebar_label: Creating and Managing Orders
description: "Create, approve, and activate sales orders in Partner Center, track order statuses, and resolve activation errors."
...
content_type: how-to
kb_id: KB-00010
answer_snippet: "To create an order, go to Commerce → Orders in Partner Center and click Create Order, then choose the account, add products and editions, and submit it for approval or processing. Processing the order activates the products and creates subscriptions."
doc_owner: commerce
...
# How do I create and manage orders in Partner Center?

## What are Orders?

To create an order, go to `Commerce` → `Orders` in Partner Center and click `Create Order`, then choose the account, add products and editions, and submit it for approval or processing. Processing the order activates the products and creates subscriptions.

Orders in Partner Center are the primary way to activate products and services for your customers. Orders cover the full sales process: creating the order, approvals, payment collection, and product activation.
...
When an order includes a product activated as a trial, the line item displays a **Trial** badge—the same badge shown on the account's Products & Services page—and the price shows as $0, since no payment is collected while the product is in trial.
...
### What can admins do with simplified sales orders? {#new-admin-actions}
