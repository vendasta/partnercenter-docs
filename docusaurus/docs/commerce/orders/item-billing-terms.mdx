...
1. In an order, click the `Automatically Renews` hyperlink below the product name.
...
Both options open the same modal for configuring the start date and renewals:
