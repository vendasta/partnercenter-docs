...
- **Scheduling settings** - Control how your availability is displayed:
  - **Availability increment** - Show time slots in increments of 15, 30, or 60 minutes.
...
- **Location** - Choose where the meeting takes place (for example, Video).
...
You can also configure additional options for each event type:
...
- **Customize invitation email** - Customize the email sent for invitations through the CRM.
- **Availability increment** - Override the default time slot increment.
