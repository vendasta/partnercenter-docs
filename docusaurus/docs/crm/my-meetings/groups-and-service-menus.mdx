...
- **Service Menus**: A structured, multi-level catalog of Groups and/or Event Types. Ideal for publishing a service booking page on a website where customers browse and select a service before booking.
