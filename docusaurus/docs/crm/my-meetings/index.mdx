...
- **Calendar settings** - Connect your Google Calendar or Microsoft 365 / Outlook calendar to check for conflicts and create events, and choose whether to show blocked time slots from that calendar on your calendar view.
