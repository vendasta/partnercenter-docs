...
This feature lets you categorize meetings as private, internal-only, or publicly accessible by link. This flexibility accommodates various meeting recording needs, including one-on-ones, confidential discussions, product meetings, HR meetings, and training sessions that require privacy.
...
Anyone with the public Meeting Summary Page link can view it. The meeting will not appear in the CRM.

### Public link behavior

- The first time public sharing is enabled, a unique public URL is generated for the meeting.
- If public sharing is turned off, the URL stops working until sharing is re-enabled.
- Re-enabling public sharing restores the same URL for that meeting instead of generating a new one.
...
| **Anyone with the link → Private** | Public URL disabled |
| **Anyone with the link → All** | Public URL disabled and CRM activity logged |
