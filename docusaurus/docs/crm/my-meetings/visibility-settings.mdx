---
title: Visibility Settings – Overview
...
> **Note:** Meetings marked *Private* on Google Calendar are still recorded. Future updates may allow for preventing Notetaker scheduling for these calls.
