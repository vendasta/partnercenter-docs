---
title: Manage Visibility Settings of Recorded Meetings
sidebar_label: Visibility Settings
description: Manage access, privacy, and CRM logging for meeting recordings, transcripts, summaries, and sales coaching.
...
This feature lets you categorize meetings as private, accessible to your company, or accessible through a public sharing URL. This flexibility accommodates various meeting recording needs, including one-on-ones, confidential discussions, product meetings, HR meetings, and training sessions that require privacy.
...
| **Meeting Summary Page** | Centralized page showing the meeting recording, transcript, summary, and sales coaching. |
...
| **Public sharing URL** | A unique meeting link created when public sharing is enabled for a recording. |
...
Anyone with the generated meeting URL can view the Meeting Summary Page, including viewers outside your company. The meeting will not appear in the CRM.

### Public sharing link behavior

- A public sharing URL is generated the first time you set a meeting to **Anyone with the link**.
- If public sharing is turned off and later turned back on, the same public sharing URL is reused.
- Turning visibility back to **Private** or **All** disables public access to that URL.
