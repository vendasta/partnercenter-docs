...
| **Meeting Details page** | Centralized page showing the meeting recording, transcript, summary, and sales coaching. |
...
`Private`  
Only meeting invitees to the Calendar event in the same namespace/Partner ID can view the Meeting Recording or Meeting Details page.

`All`  
Anyone in the same namespace/Partner ID can view the Meeting Recording or Meeting Details page. A CRM activity is logged.

`Anyone with the link`  
Anyone in the same namespace/Partner ID with access to the Meeting Details page link can view it. The meeting will not appear in the CRM.
...
You can override these defaults anytime, from either the Meeting Details page or the My Meetings Page.
...
- On the **Meeting Details page**, change Visibility Settings as needed.
