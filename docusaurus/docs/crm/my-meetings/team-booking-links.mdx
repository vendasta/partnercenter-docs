---
title: "How do I set up team booking links in My Meetings?"
sidebar_label: Team Booking Links
description: "Set up team booking links in My Meetings to share one link across a Sales Team, choose an assignment method, and manage availability."
sidebar_position: 3
brand: vendasta
product: crm
audience: partners
content_type: how-to
kb_id: KB-00121
answer_snippet: "Team booking links in My Meetings, in Partner Center, let you create one booking link that distributes meetings across a team of users. To set one up, you need the My Meetings admin role and a Sales Team, then go to My Meetings → Admin → TEAM BOOKING LINKS."
doc_owner: crm
...
Team booking links in My Meetings, in Partner Center, let you create one booking link that distributes meetings across a team of users. To set one up, you need the My Meetings admin role and a Sales Team, then go to `My Meetings` → `Admin` → `TEAM BOOKING LINKS`.

For example, your business might do a qualification call before handing a prospect over to a sales rep. You can create a team booking link for your qualification team and let My Meetings randomly distribute meetings to team members.

## How do I get to team booking links? {#creating-team-booking-links}
...
## How do I create a new team booking link? {#create-a-new-team-booking-link}
...
## How are meetings assigned to team members? {#assignment-methods}
...
- All selected hosts must have their calendar connected for accurate availability checking. Hosts without a connected calendar are excluded from availability checks.

**Best for:**
- Complex sales processes requiring multiple stakeholders (e.g., Sales Rep + Solutions Engineer)
...
## How do I select team members? {#selecting-team-members}
...
## How do I manage team availability? {#managing-availability}
...
## How do I choose which calendars are included? {#calendar-customization}

You control which team members' calendars are included in your team booking link and how their availability is managed:
...
## How do I set the timezone for team bookings? {#timezone-settings}
...
## How do I customize the booking page? {#customizing-your-booking-page}
...
## How do I view and share a team booking link? {#viewing-and-sharing-your-team-booking-link}
...
## How do I monitor team booking link performance? {#monitoring-performance}
...
<details>
<summary>How do I know if I have admin rights to create a team booking link?</summary>

The `Admin` option in My Meetings is only available to users assigned the admin role for the My Meetings section. If you don't see `Admin` in My Meetings, ask a user with that role to set up the team booking link.

</details>

<details>
<summary>Why isn't a team member showing as available on the booking page?</summary>

Only team members with connected calendars show as available for booking. Each team member must connect their personal calendar to My Meetings and grant calendar access permissions. Their working hours, buffer times, and busy calendar events also block availability.

</details>

<details>
<summary>With client selection, who chooses the team member?</summary>

The person booking the meeting chooses which team member they want to meet with on the booking page. Only team members who are available at the selected time are shown as options.

</details>

<details>
<summary>How many hosts can a multi-host meeting have?</summary>

A multi-host event type can have up to 5 hosts. All hosts must have their calendar connected, and only time slots when all selected hosts are available are shown.

</details>

<details>
<summary>Where do I find the link to share with prospects?</summary>

Open the team booking link and click `COPY LINK` to copy the booking URL to your clipboard. Click `VIEW` to see how the booking page appears to visitors.
