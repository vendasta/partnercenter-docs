...
- Turn public sharing on or off for the meeting
...
2. Choose a visibility option:
   ...
   - Anyone with the link: These meeting recordings are visible to anyone who has the public link. These meeting recordings are not logged in the CRM.
...
When you first turn on public sharing for a meeting, the platform generates a unique public URL. Turning public sharing off disables access to that URL. Turning it back on re-enables the same URL for that meeting instead of creating a new one.

:::warning
Public links are intended for broader sharing. Before sharing publicly, confirm the meeting content is appropriate for external access.
:::
