...
- Copy a shareable link to the meeting, including a public sharing URL when **Anyone with the link** is selected
...
2. Choose a visibility option:
   ...
   - Anyone with the link: These meeting recordings are visible to anyone with the generated URL, including people outside your company. These meeting recordings are not logged in the CRM.
...
When you enable **Anyone with the link** for the first time, the platform creates a public sharing URL for that meeting. If you later switch away from public sharing and re-enable it, the same URL is reused.
