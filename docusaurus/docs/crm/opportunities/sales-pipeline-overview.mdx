...
description: "View, sort, filter, and move opportunities in the Partner Center CRM pipeline, create custom pipelines, and track total and weighted revenue."
brand: vendasta
product: crm
audience: partners
content_type: overview
kb_id: KB-00156
answer_snippet: "The sales pipeline in the Partner Center CRM, at CRM → Opportunities, shows each opportunity by stage so you can track deals and forecast revenue. You can view it as a table or a board, sort and filter opportunities, and create custom pipelines with your own stage probabilities."
doc_owner: crm
...
The sales pipeline in the Partner Center CRM, at `CRM` → `Opportunities`, shows each opportunity by stage so you can track deals and forecast revenue. You can view it as a table or a board, sort and filter opportunities, and create custom pipelines with your own stage probabilities.

Knowing which stage each opportunity is in helps you take the next step to close deals, track potential revenue, and focus your team's time where it yields the highest return.

## Table view

The table view gives you a full list of either your own or a team's sales opportunities.
...
- You will find a search box above the pipeline, allowing you to search for specific types of opportunities.
  - **Note:** You can only search for opportunity types, for example Website Creation or Visibility & SEO. Other categories aren't searchable.
...
## How do I move opportunities between stages? {#moving-opportunities}
...
## What are the default pipeline stages? {#create-a-new-pipeline-stage}
...
If the default pipeline doesn't fit your business, you can create custom pipelines and define your own forecast percentages.

## How do I create a pipeline? {#create-pipelines-in-vendasta}
...
The CRM displays both total and weighted revenue for each stage of your sales pipeline. Weighted revenue is calculated using the probability assigned to each stage, showing the expected outcome at every point in your sales process.
...
This lets your pipeline reflect where each lead actually is and reduces manual adjustments in your automations.
...
The default pipeline has four stages: Lead, Contact, Qualified, and Proposal, with default probabilities of 0%, 20%, 40%, and 60%. The pipeline uses these percentages to show your revenue forecast. You can create custom pipelines with your own stages and percentages.
</details>

<details>
<summary>How do I create a custom pipeline?</summary>

Go to `CRM` → `Opportunities` → `Board`, click the pipeline view dropdown, and select `Manage Pipelines`. Click `Create Pipeline`, name it, add your stages, assign a percentage to each stage, and click `Save`.
</details>

<details>
<summary>How do I move an opportunity to a different stage?</summary>

Open the board view at `CRM` → `Opportunities` → `Board`. Click and hold the opportunity, then drag it to its new stage.
</details>

<details>
<summary>What can I search for in the pipeline table view?</summary>

The search box above the table view searches by opportunity type only, for example Website Creation or Visibility & SEO. Other categories aren't searchable.
</details>