...
To export contacts or companies from the CRM:

1. Navigate to `CRM` > `Contacts` (or `Companies`)
2. Select the contacts you want to export — or click the checkbox in the top-left corner, then click `select all...` to include all records
