...
Sales teams let you group salespeople, track performance by team, and focus coaching and resource allocation where it's needed. This creates clear accountability across your sales organization.
...
:::info
Sales teams are only available on certain [subscription tiers](https://www.vendasta.com/pricing/).
:::
...
3. Select the salespeople you want to add to the team. 
   :::info
   Can't find a salesperson in the list? Make sure you've [created a salesperson profile](/administration/my-account/my-team#create-a-salesperson) for them.
   :::
