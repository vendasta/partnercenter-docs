...
Yes, but the specific workflow is different than adding an account list. You can start a campaign from a CRM list from **CRM > Lists > click the three dots next to the desired list > More Actions > Select a service account to perform this action > Campaigns and Emails > Star a campaign for this contact**.
</details>