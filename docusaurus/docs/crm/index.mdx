---
title: CRM Overview
description: "The Vendasta CRM manages contacts, companies, opportunities, and meetings. Covers views, search, automatic email logging, and record sources."
sidebar_position: 1
brand: vendasta
product: crm
audience: partners
...
kb_id: KB-00005
answer_snippet: "The Vendasta CRM, at CRM in Partner Center, is where you manage contacts, companies, opportunities, tasks, and meetings, and track every interaction with your prospects and clients."
doc_owner: crm
...
The Vendasta CRM, at `CRM` in Partner Center, is where you manage contacts, companies, opportunities, tasks, and meetings, and track every interaction with your prospects and clients.

## Why use the CRM?

The Vendasta CRM keeps your team's contacts, deals, and communication history in one place, so everyone works from the same data and routine follow-ups can be automated.
...
- **[Field Layouts](/administration/data-management/crm-objects/field-layouts)**: Group, reorder, and hide fields to control how records are laid out
...
## How do I get started with the CRM? {#get-started}
...
## How do I log emails to the CRM automatically? {#automatic-email-capture}
...
- `Marketplace` → `My Purchases`, then click into `Yesware`
...
4. **Send the Invitation**:
   - Once you find or add the contact, check their information card for an `Invite to Business App` button. The invitation sends the contact an [onboarding email](/business-app/ai-onboarding-experience) — you can preview it and add a custom introductory message before sending.
...
<details>
<summary>When should I use companies instead of accounts?</summary>
...
The choice between accounts and companies depends on your job functions. Accounts are tailored for financial and administrative tasks, whereas companies are ideal for sales, CRM, and revenue growth activities.
</details>

<details>
<summary>What email address do I BCC to log emails in the Vendasta CRM?</summary>

For your own CRM in Partner Center, BCC `[Partner ID]@sent-mail.yourdigitalagents.com`. For a client's CRM in Business App, use their account group ID instead, like `AG-1234567@sent-mail.yourdigitalagents.com`. The sender must be a platform user and the recipient must be a CRM contact.
</details>

<details>
<summary>How do I log received emails in the CRM?</summary>

Forward them, manually or with auto-forwarding, to `[Partner ID]@received-mail.yourdigitalagents.com`, or to the client's account group ID at the same domain for a Business App CRM. The email is logged to the contact and its primary company.
</details>

<details>
<summary>What does Record Source mean on a CRM record?</summary>

Record Source shows the tool or process that created or updated the record, such as `CRM UI`, `Bulk Import`, `Web Chat`, `Form`, or an integration like `HubSpot`. See [Record sources](#record-sources) for the full list.
</details>

<details>
<summary>Is there AI for the Vendasta CRM?</summary>

Yes. CRM AI works through the [AI Sales Assistant](/ai/ai-workforce/ai-sales-assistant). It updates CRM records from sales conversations, lets you chat with your CRM data, and adds conversation intelligence with sales coaching on calls.
</details>