...
:::info
Each account can have up to 3 custom objects. Attempting to create a fourth returns a clear error message identifying the limit instead of a generic failure.
:::
