...
- [Reset passwords for Salespeople](./reset-passwords-for-salespeople)
- [Edit Salesperson contact information](./edit-salesperson-contact-information)
- [Delete Salespeople](./delete-salespeople)
- [Add a Booking Link in the Business App Contact Card](./add-a-booking-link-in-the-business-app-contact-card)
