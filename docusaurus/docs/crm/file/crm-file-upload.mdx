...
You can now upload files—PDFs, images, documents, spreadsheets, and more—and associate them with any **Contact**, **Company**, or **Opportunity** in CRM. After upload, an **AI-generated summary** of the file content appears automatically.
...
Not yet. Support for file uploads via Forms is planned for a future release.
</details>
