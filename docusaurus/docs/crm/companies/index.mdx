...
4. Click the top-left checkbox to select all visible records on the page. A banner confirms the count, for example "100 of 340 selected" — don't use the `Select all` link here, since deletion is limited to 100 records per batch.
