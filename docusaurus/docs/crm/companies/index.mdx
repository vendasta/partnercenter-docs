...
- **Source tracking**: Filter by how companies entered your CRM (form, import, manual)

### **Practical Filtering Examples**

**Sales prioritization:**
- High-value prospects: Filter by "Lead score > 75" + "Last contact > 7 days ago"
- New opportunities: Filter by "Created date: Last 30 days" + "Lifecycle stage: Lead"
- Stalled deals: Filter by "Last activity > 30 days ago" + "Lifecycle stage: Qualified"

**Team management:**
- Individual performance: Filter by "Assigned to: [Salesperson]" + "Activity date: This month"
- Territory focus: Filter by "City: [Target city]" + "Industry: [Target industry]"
- Follow-up needed: Filter by "Next task due: Overdue" or "Next task due: This week"

**Campaign targeting:**
- Industry campaigns: Filter by specific tags or industry classifications
- Geographic targeting: Filter by city, state, or region for local marketing
- Engagement-based: Filter by "Last email opened" or "Last campaign clicked"

### **Search Tips**
- **Partial matches**: Use partial company names or domains for broader results
- **Multiple criteria**: Combine search terms with filters for precise targeting
- **Saved views**: Create and save frequently used filter combinations
- **Export capabilities**: Export filtered company lists for external campaigns or analysis
