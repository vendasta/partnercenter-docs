...
You need the same permission that lets you create and edit custom fields. If you can open `Administration` → `CRM objects` and create a field, you can edit the layout.
...
## Field layouts in blueprints

Field layouts are included in blueprints. See [Blueprints](/accounts/manage-accounts/blueprints) for how blueprints are built, versioned, and applied.
