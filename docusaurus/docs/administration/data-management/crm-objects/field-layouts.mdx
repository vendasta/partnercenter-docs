...
{/* SCREENSHOT: organize-layout-button.png — Custom Fields page, Contacts selected, showing the "Organize layout" and "Create" buttons above the field table */}
...
{/* SCREENSHOT: organize-layout-editor.png — the full three-panel editor for Contacts: Unassigned on the left with the sort control, two or three named field groups in the centre, Hidden fields on the right */}
...
To bring a hidden field back, use **Restore to Unassigned**.

{/* SCREENSHOT: organize-layout-hidden.png — the Hidden fields panel with two or three fields in it, showing the "Fields here are hidden from contact records" helper text and a field's Restore action */}
