...
Field layouts are included in blueprints. See [Blueprints](/accounts/manage-accounts/blueprints) for how blueprints are built and applied.
...
- Applying a blueprint replaces the target account's layout for that object type.
