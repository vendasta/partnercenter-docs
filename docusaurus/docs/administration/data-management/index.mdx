...
1. **Define custom fields** – Go to `Partner Center` → `Administration` → `CRM objects`. Choose object type and field type (text, integer, date, dropdown, currency). Field type affects how data is stored and used in automations.
