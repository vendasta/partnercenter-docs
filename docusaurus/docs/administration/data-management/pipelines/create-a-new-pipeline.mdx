...
No, if you enter the same value for multiple stages the system will give you an error. Each pipeline stage must have a unique numerical value for the close probability.
</details>