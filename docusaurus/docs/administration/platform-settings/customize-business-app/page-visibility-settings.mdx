...
For custom guides configuration including WordPress blog integration, see the [Custom Content documentation](/docs/business-app/administration/custom-content-advanced-configuration).
