...
Snapshot Reports are marketing needs assessments that can prompt self-signup. To learn more, visit the [Snapshot Report documentation](https://docs.vendasta.com/snapshot-report/).
</details>
