---
title: Add Your Clients Settings
...
The Add Your Clients section in Customize Business App controls the various ways customers can be added to your platform. Configure self-service options, user management permissions, and referral capabilities.
...
See the dedicated [Featured Packages documentation](/accounts/manage-business-app/featured-packages).
