...
kb_id: KB-00082
answer_snippet: "Partner Center notification settings, at Administration → Client Notifications, control which notifications your team receives and how. Turn on the master toggle in Global Settings first, then set Platform or User scope and App or email delivery for each notification type."
...
Partner Center notification settings, at `Administration` → `Client Notifications`, control which notifications your team receives and how. Turn on the master toggle in `Global Settings` first, then set Platform or User scope and App or email delivery for each notification type.

Notifications keep you and your team informed about activity across orders, tasks, products, and more.
...
- **Task Manager/Fulfillment** — task assignments, updates, and completions
...
Go to `Partner Center` → `Administration` → `Client Notifications`, then expand the relevant product or area to configure each notification type.

**If I turn off Global Settings, will users receive any notifications?**
No. When the master toggle is off, no notifications are sent, regardless of individual settings.

**Who can change Platform Settings?**
Platform Settings are managed by Partner Center administrators and apply across the team. Individual users can adjust their own User Settings without affecting others.

**Can I get a notification in both the app and by email?**
Yes. For each notification type, you can enable App delivery, Email delivery, or both at the same time.
