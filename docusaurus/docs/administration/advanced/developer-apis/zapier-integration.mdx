...
Vendasta's Zapier Integration enables you to connect your Vendasta account with thousands of other applications through Zapier's automation platform. This integration allows you to automate workflows between Vendasta and other applications you use daily, extending your platform's capabilities.
...
The app can be used by Partners, Salespeople, and their clients. It uses the permissions of the user who set up the Zap. Note that the app is currently Vendasta branded, so white-labeling options are limited.
</details>
