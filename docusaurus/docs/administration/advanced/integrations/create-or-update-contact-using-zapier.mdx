...
The Vendasta App in Zapier allows you to connect your Vendasta CRM to several third-party systems using Zapier. You can select any third-party system available in Zapier as a trigger, which initiates an action in the Vendasta CRM.
...
## Step 3: Selecting the create or update action
