...
5. In the **API Tracking Identifier** section, choose **Integration Vendor** and select **AMP - Automated Marketing Platform**. This is the vendor the platform identifies itself with — if a different vendor is selected, or the identifier is set to **Custom**, Autotask rejects the connection.
6. Save the user.
