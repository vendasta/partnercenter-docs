...
You may find it necessary to restrict a Partner Center admin's access to accounts or features. For example, you may wish to do so because:
- A team member may not need access to the full list of actions
- You want to keep client information private
- You want to simplify the team member experience
...
You may find it necessary to restrict a salesperson's access to features. You may wish to do so for the following reasons:
