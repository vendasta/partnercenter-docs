...
## How to view and download invoices and credit memos

### Financial documents

Your invoices and credit memos are stored separately from the monthly billing reports. To access them:
...
3. Use the `Credit Memos` tab to view credits issued for canceled products or services
...
`Financial Documents` (`Administration` → `Financial Documents`) contain your formal invoices and credit memos in PDF format: useful for accounting, record keeping, and sharing with clients or accountants.
</details>
