...
description: "Find management fees, credit notes, vCash credits, volume commitments, and seat-based discounts in your Partner Center billing."
...
kb_id: KB-00154
answer_snippet: "Partner Center billing shows management fees as separate invoice line items, keeps credit notes from canceled services, and applies vCash virtual credits automatically to Vendasta purchases. It also shows your volume commitments and seat-based discounts."
...
Partner Center billing shows management fees as separate invoice line items, keeps credit notes from canceled services, and applies vCash virtual credits automatically to Vendasta purchases. It also shows your volume commitments and seat-based discounts.
...
<details>
<summary>Where can I see my wholesale discounts?</summary>

Go to `Partner Center` → `Administration` → `My billing` and click the `Discounts` tab. It shows your active discount agreements, including the number of committed seats and the discount rate.
