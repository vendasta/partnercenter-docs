...
description: Learn about management fees, credit memos, and vCash credits in Vendasta Partner Center billing.
tags: [management-fees, credit-memos, vcash, credits, billing-features]
keywords: [management fees, partner credit memos, vCash, virtual credits, billing credits, account credits]
---

## What are special features and credits?

Special features and credits in Partner Center include management fees visibility, credit memos for canceled services, and vCash virtual credits that can be applied to any Vendasta purchase. These features provide transparency in billing and flexible payment options.
...
| **Credit Memos** | Access credits from canceled products or services |
...
2. Click the `CSV download` option
...
## Partner credit memos

### What are credit memos?

A credit memo is a receipt issued by Vendasta to a Partner who has canceled a product or service(s) and is offered 'credits' that can be used to offset future purchases.

### How to access credit memos

Your credit memo history can be found in `Partner Center` → `Administration` → `Financial Documents` → `Credit Memos`.

![Financial Documents screen in Partner Center](./img/credit-notes.jpg)

### Using credit memos

Credit memos represent:
...
- Credit memos are accessible through Financial Documents
...
<details>
<summary>How do I access my credit memos?</summary>

Your credit memo history can be found in `Partner Center` → `Administration` → `Financial Documents` → `Credit Memos`. Credit memos are issued when you cancel products or services and receive credits for future use.
...
<details>
<summary>Do credit memos expire?</summary>

Credit memo terms may vary. Check your specific credit memo details or contact support for information about expiration dates and usage terms.
