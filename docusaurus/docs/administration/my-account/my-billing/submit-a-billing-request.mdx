...
<details>
<summary>I activated a product by mistake. How do I request a refund?</summary>

Cancel or deactivate the product on the account first, then submit a billing request to Finance at [billingrequests.vendasta.com](https://billingrequests.vendasta.com) with your Partner ID, Purchase ID, and a short explanation. Choose the activation-error reason when it fits. Submitting a request does not guarantee a refund; Finance reviews each case.
</details>
