---
title: "How do I add or update my payment method in Partner Center?"
sidebar_label: Payment Methods and Setup
description: "Add or update your credit card and billing contact in Partner Center, change the invoice email, retry failed payments, and see what happens when payments fail."
...
content_type: how-to
kb_id: KB-00073
answer_snippet: "In Partner Center, go to Administration → My billing to add your billing contact and credit card, update billing details, change the invoice email, and retry failed payments. Partner Center holds one credit card at a time."
...
## What can I do with payment methods? {#what-you-can-do-with-payment-methods}
...
## How do I set up a payment method? {#how-to-set-up-payment-methods}
...
## How do I update my billing information? {#how-to-update-existing-information}
...
## How do I manage payment issues? {#how-to-manage-payment-issues}
...
## What happens when a payment fails? {#what-happens-when-a-payment-fails}
...
## Which payment methods are accepted? {#payment-method-requirements}
...
<details>
<summary>How do I update the credit card on file?</summary>
...
<details>
<summary>Do I need to reactivate products after I fix a failed payment?</summary>
