...
id: my-billing
title: My billing
description: "How Partner Center billing works: instant and invoiced billing, renewals and cancellations, payment methods, estimated usage, and active subscriptions."
sidebar_position: 3
...
kb_id: KB-00067
answer_snippet: "My billing in Partner Center, at Administration → My billing, is where you manage your billing contact, payment methods, billing metrics, estimated usage, and active subscriptions. Products you activate renew automatically, and a canceled product stays active until its renewal date."
...
My billing in Partner Center, at `Administration` → `My billing`, is where you manage your billing contact, payment methods, billing metrics, estimated usage, and active subscriptions. Products you activate renew automatically, and a canceled product stays active until its renewal date.

This page covers the billing model and key features; use the links below for payment methods, reports, and credits.

## What is Vendasta's Billing Model?

Vendasta's billing model lets you activate and cancel products at any time of the month. When you activate a product for an account (except for "one-time" products), that product will be scheduled to renew automatically based on its billing frequency (i.e., monthly or yearly).
...
## How do I set up my billing? {#how-to-set-up-your-billing}
...
### How do I find renewal dates? {#how-to-find-renewal-dates}
...
### How do I cancel a product? {#how-to-cancel-a-product}
...
### How do I find deactivation dates? {#how-to-find-deactivation-dates}
...
### How do I undo a cancellation? {#how-to-undo-a-cancellation}
...
### How do I export estimated usage? {#exporting-estimated-usage}
...
A credit card is required on file for all partners. We accept Visa, Mastercard, and Amex. For further concerns, feel free to direct them to billingsupport@vendasta.com.
</details>
...
Not at all! With Vendasta, you can send an unlimited amount of emails on campaigns at no charge. For prospecting, Snapshot Report costs $2/account.
</details>
...
<details>
<summary>What is the difference between canceling and deactivating a product?</summary>

Canceling a product stops it from renewing. The product stays active until its next renewal date, and then it deactivates automatically. You can find the deactivation date on the **Activation History** page for the account.
</details>

<details>
<summary>Does Estimated Usage include all active subscriptions for the whole month?</summary>

The **Estimated Usage** view shows your estimated cost for the month based on the products that are active, not including managed services charges. The CSV download only counts consumption up to the date you download it, so its values differ from the view.
</details>

<details>
<summary>Where can I see how product sales affect my partner subscription?</summary>

Go to `Administration` → `My billing` → `Estimated usage` for the earn-down and usage view. Selling eligible Vendasta-owned products can reduce your subscription charge. Check Estimated usage on your account for current eligibility and amounts rather than relying on a fixed dollar example.
</details>

## Troubleshooting

### Missing billing and financial cards

If **My Plan**, **My billing**, **Reports**, **Financial Documents**, or **Pricing** cards are not visible in **Administration**, this is a permissions configuration issue, not a bug.

Each Partner Center admin has an **Access scope to reports** permission. When this is set to a restricted level — which can happen when admin permissions are updated — these cards are hidden for that admin.

Admins cannot change this setting themselves. Contact [Vendasta Support](https://support.vendasta.com) and request that the affected admin's report access be set to **Can view and edit reports**. Include the admin's email address in your request.
