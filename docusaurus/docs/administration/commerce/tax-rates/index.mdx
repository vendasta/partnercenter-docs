...
Configure tax rates, apply exemptions, and ensure accurate tax calculations on invoices, sales orders, subscription billing, and [shopping cart](/marketplace/manage-store/shopping-cart-payment-processing) purchases. The system applies tax rules automatically based on customer addresses and exemption status.
