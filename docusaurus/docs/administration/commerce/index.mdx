...
- **Billing automation** – Defaults apply to new accounts only; you can override per account under **Accounts** → **Manage Accounts** → account → **Products**.
...
- **[Default Billing Settings](./default-billing-settings/index.mdx)** – Default collection method and timing for new accounts; market-specific defaults
...
2. **Default billing** – Go to **Administration** → **Default Billing Settings**. Choose collection method (auto charge vs invoice) and timing; apply to markets if needed.
