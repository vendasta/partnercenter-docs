---
title: "How do I set up Vendasta Payments and payouts?"
...
content_type: how-to
kb_id: KB-00097
answer_snippet: "Vendasta Payments lets you invoice, bill, and collect payment from your clients under your brand, processed through Stripe. To set it up, go to Administration → Commerce Settings → Vendasta Payments in Partner Center, create an account or connect Stripe, and add a payout bank account."
...
Vendasta Payments lets you invoice, bill, and collect payment from your clients under your brand, processed through Stripe. To set it up, go to `Administration` → `Commerce Settings` → `Vendasta Payments` in Partner Center, create an account or connect Stripe, and add a payout bank account.
...
## How do I set up Vendasta Payments? {#how-to-set-up-vendasta-payments}
...
Vendasta Payments accepts payments from Visa, Mastercard, American Express, and Discover credit cards.
...
If you're a Partner with an existing Stripe Standard account, you can connect it to Vendasta Payments to use billing features, including invoicing, subscriptions, and payments.
...
:::info
This feature is only available for new users who haven't completed transactions with platform-generated accounts.
:::

## How do I set up payouts? {#how-to-set-up-payouts}
...
If you add more than one bank account to receive payouts, you need to select a default account to specify which account receives your payouts. You can change your default bank account at any time. If you connected your own Stripe account, change it in your Stripe dashboard; otherwise, contact billingsupport@vendasta.com.
...
## How does my Vendasta Payments Stripe account work? {#understanding-your-vendasta-payments-stripe-account}
...
Partners using a Vendasta Payments account don't have access to the Stripe dashboard. Only partners who connect their own Stripe account (Bring Your Own Stripe) can access their Stripe dashboard. Payment and payout reporting is available in Partner Center under `Commerce` → `Payments` and `Commerce` → `Payouts`.
...
## How do I manage my account information? {#managing-account-information}
...
**To update your legal business name in Stripe (Bring Your Own Stripe accounts only):**

If you use a Vendasta Payments account, contact billingsupport@vendasta.com to update your legal business name.
...
## What are the customer-facing Terms of Service for payment processing? {#customer-facing-terms-of-service-for-payment-processing}
...
## How do I troubleshoot setup issues? {#troubleshooting-setup-issues}
...
Automatic transfer of customer payment information is not available. You'll need to manually input payment details into the platform.
</details>
...
No. Only partners who connect their own Stripe account (Bring Your Own Stripe) can access the Stripe dashboard. For Vendasta Payments accounts, Stripe access is restricted to Billing Support. If you need assistance with your Vendasta Payments account please submit a ticket to billingsupport@vendasta.com.
</details>

<details>
<summary>Which countries is Vendasta Payments available in?</summary>

Vendasta Payments is available in the USA, Canada, New Zealand, Australia, the United Kingdom, and the Czech Republic. Germany, Belgium, the Netherlands, Poland, and Switzerland are available with sales assistance.
</details>

<details>
<summary>How long does Vendasta Payments account approval take?</summary>

After you complete the account application and configure banking details for payouts, account approval typically takes 1-2 business days.
</details>
