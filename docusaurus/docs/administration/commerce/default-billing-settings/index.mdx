...
<details>
<summary>How do I change the recurring invoice renewal day?</summary>

Do not change it from the order summary. Open billing settings from the subscription or billing area and use the renewal-date setting, then confirm when payable invoices generate. The order view is informational; billing settings control the schedule.
</details>
