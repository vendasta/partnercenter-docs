...
1. Go to Settings
2. Click on the **AI Knowledge** tab

![AI Knowledge tab](/img/social-marketing/settings/ai-knowledge-1.png)
...
![Add documents to AI Knowledge](/img/social-marketing/settings/ai-knowledge-2.png)
...
![Add websites to AI Knowledge](/img/social-marketing/settings/ai-knowledge-3.png)

## Adding Social Profiles

You can add social profiles to your AI Knowledge base for ChatGPT to reference.

1. Click the **Social Profiles** tab
2. Enter a social profile URL in the field
3. Click **Add**

![Add social profiles to AI Knowledge](/img/social-marketing/settings/ai-knowledge-4.png)
...
![Use AI Knowledge in Campaigns](/img/social-marketing/settings/ai-knowledge-5.png)
...
![AI Knowledge responses](/img/social-marketing/settings/ai-knowledge-6.png)
...
![Editing with AI Knowledge](/img/social-marketing/settings/ai-knowledge-7.png)
...
![AI Knowledge best practices](/img/social-marketing/settings/ai-knowledge-8.png)