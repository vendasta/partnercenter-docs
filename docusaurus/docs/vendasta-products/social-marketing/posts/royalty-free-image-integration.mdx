...
1. From **Social Marketing > Compose**, scroll down to the Media section and click on **Select Media**.
   ![Select Media option in the composer](/img/social-marketing/select-media.jpg)

2. Click **Free Images**, then search for a relevant keyword.
   ![Free Images search interface](/img/social-marketing/free-images.jpg)
