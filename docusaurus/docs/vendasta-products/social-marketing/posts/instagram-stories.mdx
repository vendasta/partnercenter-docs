...
1. From the **Calendar** or **Content** page, click the **Create** button, and then select **Create a Post** from the dropdown menu.

2. Select **Instagram Story** from the list of post options.

   ![Instagram Story option in create menu](/img/social-marketing/instagram-stories-1.jpg)

3. In the **Create Post** window, select the Instagram accounts where you want to publish the Story.

   ![Select Instagram accounts](/img/social-marketing/instagram-stories-2.jpg)

4. Click the **Upload** button to add an image or video to the Story. You can upload any 9:16 ratio image or video.

   ![Upload media for Instagram Story](/img/social-marketing/instagram-stories-3.jpg)

5. Once your media is uploaded, you can enhance it with text, stickers, or drawings using the editing tools on the right side of the screen.

   ![Instagram Story editing tools](/img/social-marketing/instagram-stories-4.jpg)

6. Add text to your Story by clicking the **Text** icon, typing your message, and customizing the font, color, and size.

   ![Adding text to Instagram Story](/img/social-marketing/instagram-stories-5.jpg)

7. Add stickers by clicking the **Sticker** icon and selecting from the available options.

   ![Adding stickers to Instagram Story](/img/social-marketing/instagram-stories-6.jpg)

8. Use the drawing tools to add hand-drawn elements to your Story.

   ![Drawing tools for Instagram Story](/img/social-marketing/instagram-stories-7.jpg)

9. When you're finished creating your Story, click **Next**.

10. Choose when to publish the Story:
...
11. Click **Publish**, **Schedule**, or **Save as draft** depending on your choice in the previous step.
...
- **Add interactive elements**: Use polls, questions, and other stickers to increase engagement
- **Include a call to action**: Encourage viewers to swipe up, send a message, or visit a profile
