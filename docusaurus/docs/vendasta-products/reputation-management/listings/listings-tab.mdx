...
![Primary Listings Tab](/img/reputation-management/listings/primary-listings-tab.jpg)
...
This will increase confidence in your SMB clients that the listing information portrayed is up to date. To refresh the listing, click ![Refresh Icon](/img/reputation-management/listings/refresh-icon.jpg) and click **Refresh Listing**.
...
![Citations Tab](/img/reputation-management/listings/citations-tab.jpg)