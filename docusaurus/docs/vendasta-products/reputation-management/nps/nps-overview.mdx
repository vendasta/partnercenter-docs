...
![Templates Request Tab](/img/reputation-management/nps/templates-request-tab.jpg)

- Click on the "Create Email" button to create an NPS-type email using the email builder.

![Create Email Button](/img/reputation-management/nps/create-email-button.jpg)

![Email Builder](/img/reputation-management/nps/email-builder.jpg)

- Click on **Add New Block** to insert an NPS block inside your email template.

![Add New Block](/img/reputation-management/nps/add-new-block.jpg)

![NPS Block Menu](/img/reputation-management/nps/nps-block-menu.jpg)
...
![NPS Display Options](/img/reputation-management/nps/nps-display-options.jpg)
...
![Review Requests](/img/reputation-management/nps/review-requests.jpg)
...
![Templates Selection](/img/reputation-management/nps/templates-selection.jpg)
...
![NPS Menu](/img/reputation-management/nps/nps-menu.jpg)
...
![NPS Score Breakdown](/img/reputation-management/nps/nps-score-breakdown.jpg)
...
![NPS Trends](/img/reputation-management/nps/nps-trends.jpg)
