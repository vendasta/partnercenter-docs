...
![Review request options](/img/vendasta-products/reputation-management/reviews/sms-review-requesting/image1.png)

If a user selects 'Just Email,' only email-related options will show such as the email template and email preview.

{/* ![Email template options](/img/vendasta-products/reputation-management/reviews/sms-review-requesting/image2.png) */}
...
{/* ![SMS review options](/img/vendasta-products/reputation-management/reviews/sms-review-requesting/image3.png) */}

If a user selects 'Email and SMS,' it will show template previews for both.

{/* ![Email and SMS options](/img/vendasta-products/reputation-management/reviews/sms-review-requesting/image4.png) */}
...
{/* ![Credit usage](/img/vendasta-products/reputation-management/reviews/sms-review-requesting/image5.png) */}