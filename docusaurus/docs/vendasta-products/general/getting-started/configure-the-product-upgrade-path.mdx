...
5. For setting the upgrade path to **Upgrade to a custom package**, [follow these instructions](/vendasta-products/general/getting-started/configure-standard-products-upgrade-paths-to-custom-packages).
