...
2. ***If your service is reliant on a Vendasta product*** AND involves responding to reviews, claiming, and filing listings, or reviewing mentions you can also choose to have system-generated tasks created upon product activation. These are event-triggered tasks: Reviews, Mentions, and Listings.
