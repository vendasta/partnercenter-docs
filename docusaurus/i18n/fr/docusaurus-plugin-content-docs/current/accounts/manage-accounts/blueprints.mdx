...
![Boîte de dialogue de création de modèle de compte affichant l'étape Configure avec des cases à cocher pour AI Employees, CRM Custom Fields, Promotions et d'autres composants](./img/blueprints1.png)
...
![Liste des Account Templates affichant le nom d'un modèle, le compte source, le contenu et la date de création](./img/blueprints3.png)
...
![Boîte de dialogue d'application d'un modèle de compte affichant la sélection du compte cible et les cases à cocher des fonctionnalités](./img/blueprints2.png)
