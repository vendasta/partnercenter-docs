...
![Diálogo de creación de plantilla de cuenta mostrando el paso Configure con casillas de verificación para AI Employees, CRM Custom Fields, Promotions y otros componentes](./img/account-templates1.png)

## Cómo acceder

Para ver, crear, actualizar o aplicar plantillas manualmente, ve a Partner Center → `Accounts` → `Account Templates`.

![Lista de Account Templates mostrando el nombre de una plantilla, la cuenta de origen, el contenido y la fecha de creación](./img/account-templates3.png)
...
![Diálogo de aplicación de plantilla de cuenta mostrando la selección de la cuenta de destino y las casillas de verificación de funciones](./img/account-templates2.png)
