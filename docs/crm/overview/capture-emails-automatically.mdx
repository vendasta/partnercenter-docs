...
- If you are setting this up for your client's CRM in the Business App, you should use the [account group ID](/crm/overview/what-is-an-account-group-id) as the prefix of the email address, following this format: [Account Group ID]@sent-mail.yourdigitalagents.com
...
- If you are setting this up for your client's CRM in the Business App, you should use the [account group ID](/crm/overview/what-is-an-account-group-id) as the prefix of the email address, like this: [Account Group ID]@received-mail.yourdigitalagents.com
