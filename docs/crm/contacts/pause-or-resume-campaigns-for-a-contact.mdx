...
- Pausing campaigns affects all active campaigns for the contact
- Campaign history and data are preserved when campaigns are paused
- Campaign schedules may be adjusted when resumed to account for the pause period
- The pause/resume status is visible in the contact's campaign tab
- You can pause and resume campaigns as many times as needed