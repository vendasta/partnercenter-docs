...
6. Add the tasks you wish to create for projects created with this template. [Learn more about templates](/fulfillment/fulfillment-open-task-manager/fulfillment-open-task-manager-templates).
