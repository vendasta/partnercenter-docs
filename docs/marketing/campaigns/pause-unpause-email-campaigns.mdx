...
1. Account(s) on the campaign is missing a Snapshot Report when a Snapshot is required for the campaign. Retry after ensuring that all accounts have a Snapshot Report. See [this article](/marketing/marketing-campaigns/leverage-snapshot-creation) for more details on how to leverage the Snapshot Creation campaign step within your email campaign.
