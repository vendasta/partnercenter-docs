...
Adding users to a multi-location group will allow them to be viewed in [Multi-Location Business App](/accounts/multi-location-groups/multi-location-business-app).
