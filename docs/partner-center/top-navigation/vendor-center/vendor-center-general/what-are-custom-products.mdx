...
Speaking of selling, when you [create a product](https://support.vendasta.com/hc/en-us/articles/24294790793751-Marketplace-Create-Product), you have complete control over everything you need to start selling it to your customers: its name, price, marketing material, order form, and much more are all fully customizable. 
...
Editions of a product share marketing material and add-ons, but each edition can have its own [price settings](/partner-center/partner-center-top-navigation/vendor-center/set-your-products-price).
