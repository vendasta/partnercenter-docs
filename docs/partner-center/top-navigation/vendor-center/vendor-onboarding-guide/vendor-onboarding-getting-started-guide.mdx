...
The majority of Resellers opt into [Vendor communications via the Vendasta Inbox](https://support.vendasta.com/hc/en-us/articles/6926511028887-Inbox-in-platform-messaging-in-Partner-Center#:~:text=Partner%2Dto%2DVendor%20Chat). **It is expected that your team will monitor and respond to communications from the Resellers that are selling your products.**
...
Notification preferences are set per Team Member within Partner Center. For additional information about Reseller Notifications, please refer to the [Reseller Notification Guide](/partner-center/vendor-center/vendor-onboarding-guide/operational-requirements-for-marketplace-vendors).
...
*To learn more about Partner Center check out this* [Article](/partner-center/home-page-overview/partner-center-overview)
...
- [Access the Business App](/partner-center/home-page-overview/partner-center-overview)
