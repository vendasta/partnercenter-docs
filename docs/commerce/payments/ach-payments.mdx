...
1. Select the client account and go to **Subscriptions > Billing Settings** to enable subscription billing if you haven't already done so. Refer to [this article](https://support.vendasta.com/hc/en-us/articles/4406959774615-Subscription-Billing) on subscription billing.
