...
2. Select the items you want to activate.
   ...
   - **Can't find a certain item in the list?** Make sure to [start selling it first](https://support.vendasta.com/hc/en-us/articles/4406952901015). It may take a few minutes to appear after you start selling.
...
If your customers have [access to Business App](https://support.vendasta.com/hc/en-us/articles/4406958099991), they'll now be able to access these products from the **My Products** tab.

## Multiple accounts

This feature is only available for Partners on a *paid* subscription.

To activate products for multiple accounts at once, you need to first [add those accounts to a List](https://support.vendasta.com/hc/en-us/articles/4406951975191). Once you have created the List:
...
3. Select the product(s) you want to activate.
   ...
   **Can't find the product in the list?**
   - Make sure to [start selling the product](https://support.vendasta.com/hc/en-us/articles/4406952901015).
