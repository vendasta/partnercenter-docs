...
Partners [invoicing](/commerce/commerce-invoices/invoicing-overview) their customers or accepting purchases through [the Shopping Cart](/commerce/commerce-shopping-cart/shopping-cart-overview) using [Vendasta Payments](/commerce/commerce-payment-processing/vendasta-payments) may find it necessary to charge taxes on the products and services they sell. Tax rates can be specified and applied to invoice line items, as well as Shopping Cart purchases and sales orders, to ensure that you are collecting the appropriate taxes from your customers.
...
*To see a full list of Merchant Services/Vendasta Payments feature availability, [click here](/commerce/commerce-payment-processing/merchant-services-feature-availability).*
...
*Learn about how to use Tax Exemptions [here](/commerce/commerce-taxes/tax-exemptions).*
