...
![Template menu in Reputation Management](/img/reputation-management/templates/sms-template-step1.jpg)

- Under the **Requests** tab, you will find two sections: **Email and SMS.**

![Email and SMS tabs in Templates section](/img/reputation-management/templates/sms-template-email-sms-tabs.jpg)

- In the SMS section, click **Create SMS.**

![Create SMS button](/img/reputation-management/templates/sms-template-create-sms-button.jpg)
...
![Request type selection popup](/img/reputation-management/templates/sms-template-request-type.jpg)

- After selecting the request type, the SMS builder will open. 

![SMS template builder interface](/img/reputation-management/templates/sms-template-builder.jpg)
...
![Saved SMS template](/img/reputation-management/templates/sms-template-saved.jpg)
...
![SMS templates listing](/img/reputation-management/templates/sms-template-listing.jpg)
...
![SMS template menu options](/img/reputation-management/templates/sms-template-menu.jpg)
...
![Delete confirmation popup](/img/reputation-management/templates/sms-template-delete-confirm.jpg)

![Delete and cancel options](/img/reputation-management/templates/sms-template-delete-options.jpg)
...
![Review request template](/img/reputation-management/templates/sms-template-review-request.jpg)
...
![NPS request template](/img/reputation-management/templates/sms-template-nps-request.jpg)
