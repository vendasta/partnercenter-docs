...
![Response Templates menu navigation](/img/reputation-management/templates/response-templates-menu.jpg)
...
![Response Templates list](/img/reputation-management/templates/response-templates-list.jpg)

![Response Templates columns option](/img/reputation-management/templates/response-templates-columns.jpg)
...
![Response Templates form](/img/reputation-management/templates/response-templates-form.jpg)

![Response Templates kabob menu](/img/reputation-management/templates/response-templates-kabob.jpg)
...
![Response Templates edit page](/img/reputation-management/templates/response-templates-edit.jpg)
...
![Response Templates dynamic field option](/img/reputation-management/templates/response-templates-dynamic-field.jpg)

List of available dynamic fields:

![Response Templates dynamic fields list](/img/reputation-management/templates/response-templates-dynamic-fields-list.jpg)
