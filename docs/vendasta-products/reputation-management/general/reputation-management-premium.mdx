...
![Review Requests Management](/img/vendasta-products/reputation-management/premium/request-review.jpg)

2. Select the review site(s) where you want to direct customers to leave reviews

![Select Recipients](/img/vendasta-products/reputation-management/premium/select-recipients.jpg)
...
![Add Recipients](/img/vendasta-products/reputation-management/premium/add-recipients.jpg)
...
![Multiple Emails](/img/vendasta-products/reputation-management/premium/multiple-emails.jpg)

6. After adding recipients, select "Add Recipients" to proceed to the email template page

![Email Template](/img/vendasta-products/reputation-management/premium/email-template.jpg)
...
![Email Editor](/img/vendasta-products/reputation-management/premium/email-editor.jpg)
...
![Review Requests](/img/vendasta-products/reputation-management/premium/review-requests.jpg)
