...
![Analytics Tab in Reputation Management](/img/reputation-management/request-performance/analytics-tab.png)

## Using the Request Performance Metrics

The Request Performance section displays:

![Requests Section](/img/reputation-management/request-performance/requests-section.png)
...
![Graph Insights](/img/reputation-management/request-performance/graph-insights.png)

### Interactive Features

- **Mouse over data points**: View detailed information for specific dates

![Mouse Over Data Point](/img/reputation-management/request-performance/mouse-over.png)

- **Date Range Selection**: Customize the time period for the data displayed

![Date Range Selection](/img/reputation-management/request-performance/date-range.png)
