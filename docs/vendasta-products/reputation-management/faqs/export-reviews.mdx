...
2. Click on the **More Options** icon (three dots) in the top right corner
   ![options icon in review interface](/img/reputation-management/icon-options.jpg)
3. Then, select **Export to CSV**

![Reputation overview with export options](/img/reputation-management/reputation-overview.jpg)
...
![Export to CSV option in the interface](/img/reputation-management/export-to-csv.jpg)
