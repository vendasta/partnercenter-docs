...
| **Facebook** | `Not intuitive message ( :{"error":{"code":1,"message":"An unknown error occurred","error_subcode":99}})` | ![Facebook error message](/img/social-marketing/facebook-error-message.jpg) |
