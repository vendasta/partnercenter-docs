...
![Social Marketing Pro](/img/social-marketing/edit-instructions-with-ai/social-marketing-pro.jpg)

**Step 4 -** Write a post in the text box or click **Write with AI.**

**Step 5 -** Once **Improve with AI** is clicked, it opens up a conversation box which allows you to -
...
![Improve with AI options](/img/social-marketing/edit-instructions-with-ai/improve-with-ai-options.jpg)

![AI conversation box](/img/social-marketing/edit-instructions-with-ai/ai-conversation-box.jpg)
