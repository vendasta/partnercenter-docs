...
Access Social Marketing from within your Partner Center account:

1. Navigate to the App Center in your Partner Center
2. Find and select the Social Marketing app
3. Click on the **Compose** tab to start creating content
...
1. In the **Compose** tab, select the accounts you want to post to from the list on the left
2. You can filter accounts by platform (Facebook, Twitter, LinkedIn, etc.)

![Select accounts to post to](/img/social-marketing/post-to-accounts.jpg)
...
![AI Content Generation](/img/social-marketing/ai-content-generation.jpg)
...
![Template Icon](/img/social-marketing/template-icon.jpg)
...
![Shorten Link Icon](/img/social-marketing/shorten-link-icon.jpg)
...
![Content Share Icon](/img/social-marketing/content-share-icon.jpg)
