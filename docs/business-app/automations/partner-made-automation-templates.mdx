...
![Manage Client Templates menu option](/img/business-app/business-app-automations/templates-manage-client-templates.png)
...
![Automations tab with Templates option](/img/business-app/business-app-automations/templates-automation-tab.png)
...
![Create button for templates](/img/business-app/business-app-automations/templates-create-button.png)

**Step 4 -** Create an automation.

**Step 5 -** Use the toggle on the top right-hand side of the page to publish the template.

![Publish toggle for templates](/img/business-app/business-app-automations/templates-publish-toggle.png)
