...
![Add sub-group button](/img/business-app/multi-location/sub-groups/add-subgroup-button.png)
...
![Create nested sub-group](/img/business-app/multi-location/sub-groups/create-nested-subgroup.png)
